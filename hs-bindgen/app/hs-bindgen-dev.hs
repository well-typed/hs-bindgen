...
execMode Dev{..} = \case
    ...
    ModeBindingSpec BindingSpecModeBase -> BS.putStr $
      "# Generated by hs-bindgen-dev binding-spec base.  DO NOT EDIT.\n"
        <> BindingSpec.encodeYaml Stdlib.baseBindings
    ModeBindingSpec BindingSpecModeRuntime -> BS.putStr $
      "# Generated by hs-bindgen-dev binding-spec runtime.  DO NOT EDIT.\n"
        <> BindingSpec.encodeYaml Stdlib.runtimeBindings
  where
