...
// extern int foo(union u3 x);

// extern int bar(union u3 * x);

// extern union u3 baz(int x);

// extern union u3 * bur(int x);

// struct s1 { int x1; int x2;};

// extern int foo_s(struct s1 x);

// extern int bar_s(struct s1 * x);

// extern struct s1 baz_s(int x);

// extern struct s1 * bur_s(int x);
