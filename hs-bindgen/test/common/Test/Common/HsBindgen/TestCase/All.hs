...
module Test.Common.HsBindgen.TestCase.All (
  ...
  , testCaseSpecs_bespoke_types
    ...
    -- ** Arrays
  , spec_arrays_array
  , spec_arrays_multi_dim
    -- ** Attributes
  , spec_attributes_asm
  , spec_attributes_visibility_attributes
    -- ** Binding specs
  , spec_bindingSpecs_omit_type
  , spec_bindingSpecs_name_squash_both
  , spec_bindingSpecs_name_squash_struct
  , spec_bindingSpecs_name_squash_typedef
  , spec_bindingSpecs_name_type
  , spec_bindingSpecs_macro_trans_dep_missing
  , spec_bindingSpecs_rep_emptydata_enum
  , spec_bindingSpecs_rep_emptydata_macro_type
  , spec_bindingSpecs_rep_emptydata_opaque
  , spec_bindingSpecs_rep_emptydata_struct
  , spec_bindingSpecs_rep_emptydata_typedef
  , spec_bindingSpecs_rep_emptydata_union
  ...
  , spec_programAnalysis_selection_matches_c_names_1
  , spec_programAnalysis_selection_matches_c_names_2
...
testCaseSpecs_default = [
    ...
    , defaultSpec "types/primitives/primitive_insts"
    ...
    , defaultSpec "types/stdlib/stdlib_insts"
...
spec_arrays_multi_dim :: TestCaseSpec
spec_arrays_multi_dim = defaultSpec "arrays/multi_dim"
...
spec_bindingSpecs_omit_type :: TestCaseSpec
spec_bindingSpecs_omit_type =
    (defaultSpec "binding-specs/omit_type")
      { specPrescriptive = Just "examples/golden/binding-specs/omit_type_p.yaml"
      }
...
spec_bindingSpecs_name_squash_both :: TestCaseSpec
spec_bindingSpecs_name_squash_both =
    (defaultSpec "binding-specs/name/squash_both")
      { specPrescriptive = Just "examples/golden/binding-specs/name/squash_both_p.yaml"
      }

-- | Naming a squashed type, specifying the name for the struct
spec_bindingSpecs_name_squash_struct :: TestCaseSpec
spec_bindingSpecs_name_squash_struct =
    (defaultSpec "binding-specs/name/squash_struct")
      { specPrescriptive = Just "examples/golden/binding-specs/name/squash_struct_p.yaml"
      }

-- | Naming a squashed type, specifying the name for the typedef
spec_bindingSpecs_name_squash_typedef :: TestCaseSpec
spec_bindingSpecs_name_squash_typedef =
    (defaultSpec "binding-specs/name/squash_typedef")
      { specPrescriptive = Just "examples/golden/binding-specs/name/squash_typedef_p.yaml"
      }

-- | Naming a type
spec_bindingSpecs_name_type :: TestCaseSpec
spec_bindingSpecs_name_type =
    (defaultSpec "binding-specs/name/type")
      { specPrescriptive = Just "examples/golden/binding-specs/name/type_p.yaml"
      }
...
spec_bindingSpecs_rep_emptydata_enum :: TestCaseSpec
spec_bindingSpecs_rep_emptydata_enum =
    (defaultSpec "binding-specs/rep/emptydata/enum")
      { specPrescriptive = Just "examples/golden/binding-specs/rep/emptydata/enum_p.yaml"
      }

-- | Making a macro type opaque
spec_bindingSpecs_rep_emptydata_macro_type :: TestCaseSpec
spec_bindingSpecs_rep_emptydata_macro_type =
    (defaultSpec "binding-specs/rep/emptydata/macro_type")
      { specPrescriptive = Just "examples/golden/binding-specs/rep/emptydata/macro_type_p.yaml"
      }

-- | Opaque types work with representation emptydata
spec_bindingSpecs_rep_emptydata_opaque :: TestCaseSpec
spec_bindingSpecs_rep_emptydata_opaque =
    (defaultSpec "binding-specs/rep/emptydata/opaque")
      { specPrescriptive = Just "examples/golden/binding-specs/rep/emptydata/opaque_p.yaml"
      }

-- | Making a struct type opaque
spec_bindingSpecs_rep_emptydata_struct :: TestCaseSpec
spec_bindingSpecs_rep_emptydata_struct =
    (defaultSpec "binding-specs/rep/emptydata/struct")
      { specPrescriptive = Just "examples/golden/binding-specs/rep/emptydata/struct_p.yaml"
      , onFrontend = \cfg -> cfg
...
spec_bindingSpecs_rep_emptydata_typedef :: TestCaseSpec
spec_bindingSpecs_rep_emptydata_typedef =
    (defaultSpec "binding-specs/rep/emptydata/typedef")
      { specPrescriptive = Just "examples/golden/binding-specs/rep/emptydata/typedef_p.yaml"
      , onFrontend = \cfg -> cfg
          & #selectPredicate .~ BIf (SelectHeader FromMainHeaders)
          & #programSlicing .~ EnableProgramSlicing
      }
...
spec_bindingSpecs_rep_emptydata_union :: TestCaseSpec
spec_bindingSpecs_rep_emptydata_union =
    (defaultSpec "binding-specs/rep/emptydata/union")
      { specPrescriptive = Just "examples/golden/binding-specs/rep/emptydata/union_p.yaml"
      , onFrontend = \cfg -> cfg
          & #selectPredicate .~ BIf (SelectHeader FromMainHeaders)
          & #programSlicing .~ EnableProgramSlicing
      }
...
spec_programAnalysis_selection_matches_c_names_1 :: TestCaseSpec
spec_programAnalysis_selection_matches_c_names_1 =
    (defaultSpec "program-analysis/selection_matches_c_names")
      { name = "program-analysis/selection_matches_c_names.1.positive_case"
...
spec_programAnalysis_selection_matches_c_names_2 :: TestCaseSpec
spec_programAnalysis_selection_matches_c_names_2 =
    (defaultSpec "program-analysis/selection_matches_c_names")
      { name = "program-analysis/selection_matches_c_names.2.negative_case"
      , specPrescriptive = Just "examples/golden/program-analysis/selection_matches_c_names.yaml"
      , onFrontend = #selectPredicate .~
            BOr
              (BIf (SelectDecl $ DeclNameMatches "functionWithAssignedHaskellNameByNameMangler"))
