...
foreign import ccall safe "hs_bindgen_test_fun_attributes_2e369f5f60ff28c5" __f1_ptr
  :: F.FunPtr (IO ())

foreign import ccall safe "hs_bindgen_test_fun_attributes_8b60d38de80093fa" f1
  :: IO ()

foreign import ccall safe "hs_bindgen_test_fun_attributes_a1b79fe9af8e18b8" f1_ptr
  :: F.FunPtr (IO ())
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_df18e1ec526fabcf" my_memalign_ptr
  :: F.FunPtr (Size_t -> Size_t -> IO (F.Ptr Void))
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_1371a36b12f9bdfc" my_calloc_ptr
  :: F.FunPtr (Size_t -> Size_t -> IO (F.Ptr Void))
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_149f0ffc9a274b08" my_realloc_ptr
  :: F.FunPtr ((F.Ptr Void) -> Size_t -> IO (F.Ptr Void))

foreign import ccall safe "hs_bindgen_test_fun_attributes_4cb3f4400795f3dc" my_alloc1
  :: Size_t
  -> IO (F.Ptr Void)

foreign import ccall safe "hs_bindgen_test_fun_attributes_8764901d3de7c252" my_alloc1_ptr
  :: F.FunPtr (Size_t -> IO (F.Ptr Void))

foreign import ccall safe "hs_bindgen_test_fun_attributes_e3dd92fe5b87fb45" my_alloc2
  :: Size_t
  -> IO (F.Ptr Void)

foreign import ccall safe "hs_bindgen_test_fun_attributes_0e2a7c466f494b53" my_alloc2_ptr
  :: F.FunPtr (Size_t -> IO (F.Ptr Void))
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_631c7b52d4d4fe3a" square_ptr
  :: F.FunPtr (FC.CInt -> IO FC.CInt)

foreign import ccall safe "hs_bindgen_test_fun_attributes_1dddc7f5a16104d4" old_fn
  :: IO FC.CInt

foreign import ccall safe "hs_bindgen_test_fun_attributes_407cc567cd7ef4a1" old_fn_ptr
  :: F.FunPtr (IO FC.CInt)
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_60702a9764046d9e" my_dgettext_ptr
  :: F.FunPtr ((F.Ptr FC.CChar) -> (F.Ptr FC.CChar) -> IO (F.Ptr FC.CChar))
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_e8eae9d0dd40ede4" fdopen_ptr
  :: F.FunPtr (FC.CInt -> (F.Ptr FC.CChar) -> IO (F.Ptr FILE))

foreign import ccall safe "hs_bindgen_test_fun_attributes_4a86b0420a250963" f2
  :: IO ()

foreign import ccall safe "hs_bindgen_test_fun_attributes_74cfd16f2b7e27ba" f2_ptr
  :: F.FunPtr (IO ())
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_de9d3228e8bac25c" my_memcpy_ptr
  :: F.FunPtr ((F.Ptr Void) -> (F.Ptr Void) -> Size_t -> IO (F.Ptr Void))

foreign import ccall safe "hs_bindgen_test_fun_attributes_fd569d78d0ba9fd9" fatal
  :: IO ()

foreign import ccall safe "hs_bindgen_test_fun_attributes_4a9c795c1867222e" fatal_ptr
  :: F.FunPtr (IO ())
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_241bedb74b8016f3" hash_ptr
  :: F.FunPtr ((F.Ptr FC.CChar) -> IO FC.CInt)
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_adfbe41965d544a3" mymalloc_ptr
  :: F.FunPtr (Size_t -> IO (F.Ptr Void))

foreign import ccall safe "hs_bindgen_test_fun_attributes_f2d6c9a4f06efd88" foobar
  :: IO ()

foreign import ccall safe "hs_bindgen_test_fun_attributes_730ef6ad01273b1d" foobar_ptr
  :: F.FunPtr (IO ())

foreign import ccall safe "hs_bindgen_test_fun_attributes_ab8f0d32c1f84295" core2_func
  :: IO FC.CInt

foreign import ccall safe "hs_bindgen_test_fun_attributes_abb5c394ed250f25" core2_func_ptr
  :: F.FunPtr (IO FC.CInt)

foreign import ccall safe "hs_bindgen_test_fun_attributes_f50d1e8063148c18" sse3_func
  :: IO FC.CInt

foreign import ccall safe "hs_bindgen_test_fun_attributes_12616d0501d14a7a" sse3_func_ptr
  :: F.FunPtr (IO FC.CInt)

foreign import ccall safe "hs_bindgen_test_fun_attributes_1b95ce9d55223970" f3
  :: IO ()

foreign import ccall safe "hs_bindgen_test_fun_attributes_08809dca6bfda237" f3_ptr
  :: F.FunPtr (IO ())
...
foreign import ccall safe "hs_bindgen_test_fun_attributes_9d0d1087d0fa4b10" fn_ptr
  :: F.FunPtr (IO FC.CInt)

foreign import ccall safe "hs_bindgen_test_fun_attributes_fd90ce98862f93f3" y
  :: IO FC.CInt

foreign import ccall safe "hs_bindgen_test_fun_attributes_2d9291944d890d18" y_ptr
  :: F.FunPtr (IO FC.CInt)

foreign import ccall safe "hs_bindgen_test_fun_attributes_8dadf866461c7be6" x1
  :: IO FC.CInt

foreign import ccall safe "hs_bindgen_test_fun_attributes_8839814efdc23f88" x1_ptr
  :: F.FunPtr (IO FC.CInt)

foreign import ccall safe "hs_bindgen_test_fun_attributes_31759f8ffef2c6b0" x2
  :: IO FC.CInt

foreign import ccall safe "hs_bindgen_test_fun_attributes_c63d8c58f9a27a01" x2_ptr
  :: F.FunPtr (IO FC.CInt)
