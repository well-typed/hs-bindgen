      ...
      structFields = [
        Field {
          ...
          fieldComment = Just
            (Comment
              Nothing
              (Just "type_attributes.h:8:18")
              (Just "type_attributes.h")
              [])}],
      structOrigin = Just
        Decl {
          declInfo = DeclInfo {
