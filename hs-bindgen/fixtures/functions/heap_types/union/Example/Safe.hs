...
foreign import ccall safe "hs_bindgen_9fc5746860ab93cb" hs_bindgen_9fc5746860ab93cb ::
     Ptr.Ptr T
  -> Ptr.Ptr T
  -> IO ()
...
fun_wrapper ::
  ...
  -> Ptr.Ptr T
  -> IO ()
fun_wrapper = hs_bindgen_9fc5746860ab93cb
  ...
  \x0 ->
    F.with x0 (\y1 ->
                 HsBindgen.Runtime.CAPI.allocaAndPeek (\z2 ->
                                                         hs_bindgen_9fc5746860ab93cb y1 z2))
