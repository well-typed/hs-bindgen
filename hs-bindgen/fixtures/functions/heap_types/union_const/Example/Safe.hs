...
foreign import ccall safe "hs_bindgen_8a303cd5b4f7787b" hs_bindgen_8a303cd5b4f7787b ::
...
fun_wrapper ::
  ...
  -> HsBindgen.Runtime.ConstPtr.ConstPtr T
  -> IO ()
fun_wrapper = hs_bindgen_8a303cd5b4f7787b
  ...
  \x0 ->
    F.with x0 (\y1 ->
                 HsBindgen.Runtime.CAPI.allocaAndPeek (\z2 ->
                                                         hs_bindgen_8a303cd5b4f7787b (HsBindgen.Runtime.ConstPtr.ConstPtr y1) z2))
