...
-}
foreign import ccall safe "hs_bindgen_test_functionsdecls_in_signature_001a08d4459ec455" normal_wrapper_base ::
...
{-| This is an internal function.
-}
foreign import ccall safe "hs_bindgen_test_functionsdecls_in_signature_a2f84d2570ef3892" f1_wrapper_base ::
  HsBindgen.Runtime.Marshallable.MarshallableBaseType (
...
{-| This is an internal function.
-}
foreign import ccall safe "hs_bindgen_test_functionsdecls_in_signature_1d043de05a457e90" f2_wrapper_base ::
  HsBindgen.Runtime.Marshallable.MarshallableBaseType (
       Ptr.Ptr Named_union
    -> IO ()
    )
