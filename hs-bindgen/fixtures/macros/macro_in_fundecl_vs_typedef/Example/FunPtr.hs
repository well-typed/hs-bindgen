...
foreign import ccall unsafe "hs_bindgen_fb1d9bc73e620f06" hs_bindgen_fb1d9bc73e620f06_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr (MC -> TC -> IO FC.CChar)))
...
foreign import ccall unsafe "hs_bindgen_9dc824587cab07a2" hs_bindgen_9dc824587cab07a2_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr (MC -> FC.CChar -> IO TC)))
...
foreign import ccall unsafe "hs_bindgen_03d794639e412075" hs_bindgen_03d794639e412075_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr (FC.CFloat -> (Ptr.Ptr TC) -> IO (Ptr.Ptr MC))))
...
foreign import ccall unsafe "hs_bindgen_0a5eb04fc739212a" hs_bindgen_0a5eb04fc739212a_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr (FC.CFloat -> (Ptr.Ptr MC) -> IO (Ptr.Ptr TC))))
...
foreign import ccall unsafe "hs_bindgen_6d4f35a86a00c68b" hs_bindgen_6d4f35a86a00c68b_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr ((Ptr.Ptr Struct2) -> MC -> IO ())))
...
foreign import ccall unsafe "hs_bindgen_af92d1197a77fe13" hs_bindgen_af92d1197a77fe13_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr ((Ptr.Ptr Struct3_t) -> MC -> IO ())))
...
foreign import ccall unsafe "hs_bindgen_c5effcd02d3d5efd" hs_bindgen_c5effcd02d3d5efd_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr ((Ptr.Ptr Struct4) -> MC -> IO ())))
...
foreign import ccall unsafe "hs_bindgen_842a0d61a7a895d6" hs_bindgen_842a0d61a7a895d6_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr ((Ptr.Ptr Struct1) -> MC -> IO ())))
...
foreign import ccall unsafe "hs_bindgen_ead25a696827a8f7" hs_bindgen_ead25a696827a8f7_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (IO (Ptr.FunPtr ((Ptr.Ptr Struct3) -> MC -> IO ())))
