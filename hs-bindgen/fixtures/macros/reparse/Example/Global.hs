...
-- __unique:__ @test_macrosreparse_Example_get_global1@
hs_bindgen_feda7c77651645fe :: IO (RIP.Ptr A)
...
-- __unique:__ @test_macrosreparse_Example_get_global2@
hs_bindgen_61b4abc5e1afa043 :: IO (RIP.Ptr (RIP.Ptr A))
...
-- __unique:__ @test_macrosreparse_Example_get_global3@
hs_bindgen_f9bcb9580741dbc1 :: IO (RIP.Ptr (RIP.Ptr (RIP.Ptr A)))
...
{-| __C declaration:__ @global3@
    ...
    __exported by:__ @macros\/reparse.h@
-}
global3 :: RIP.Ptr (RIP.Ptr (RIP.Ptr A))
global3 =
...
-- __unique:__ @test_macrosreparse_Example_get_const2@
hs_bindgen_6c69b6e35fe122c5 :: IO (PtrConst.PtrConst (RIP.Ptr A))
...
-}
hs_bindgen_4a0e98a60a6414ee :: PtrConst.PtrConst (RIP.Ptr A)
...
-- __unique:__ @test_macrosreparse_Example_get_const3@
hs_bindgen_da21ad94b09d46ae :: IO (PtrConst.PtrConst (RIP.Ptr (RIP.Ptr A)))
...
-}
hs_bindgen_0d6ba48ba79ada14 :: PtrConst.PtrConst (RIP.Ptr (RIP.Ptr A))
hs_bindgen_0d6ba48ba79ada14 =
  RIP.unsafePerformIO hs_bindgen_da21ad94b09d46ae

{-# NOINLINE const3 #-}
const3 :: RIP.Ptr (RIP.Ptr A)
const3 =
