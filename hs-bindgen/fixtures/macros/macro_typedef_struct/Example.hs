      ...
      \i1 ->
        \struct2 ->
          \s3 ->
            case struct2 of
              Bar bar_x4 bar_y5 ->
                case Data.Primitive.Types.writeByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#)) bar_x4 s3 of
                  s6 ->
                    Data.Primitive.Types.writeByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)) bar_y5 s6
      ...
      \i1 ->
        \struct2 ->
          \s3 ->
            case struct2 of
              Bar bar_x4 bar_y5 ->
                case Data.Primitive.Types.writeOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#)) bar_x4 s3 of
                  s6 ->
                    Data.Primitive.Types.writeOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)) bar_y5 s6
