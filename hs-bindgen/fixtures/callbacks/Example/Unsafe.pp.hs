...
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_f0d72410d79899b5" readFileWithProcessor ::
...
{-| __C declaration:__ @watchTemperature@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_a445b9cacb08ed71" watchTemperature ::
     Ptr.FunPtr (FC.CInt -> IO ())
...
{-| __C declaration:__ @onFileOpened@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_b71e59965bcc2316" onFileOpened ::
...
{-| __C declaration:__ @onProgressChanged@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_013e79fc3cd3b1b4" onProgressChanged ::
     ProgressUpdate
...
{-| __C declaration:__ @validateInput@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_697a7b01b3d64c58" validateInput ::
     DataValidator
...
{-| __C declaration:__ @onNewMeasurement@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_f291b861b36d5a90" onNewMeasurement ::
     MeasurementReceived
...
{-| __C declaration:__ @onNewMeasurement2@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_4f36523b7d965e44" onNewMeasurement2 ::
...
{-| __C declaration:__ @onBufferReady@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_92d54aaf9e8a1c8e" onBufferReady ::
     SampleBufferFull
     {- ^ __C declaration:__ @handler@
     -}
  -> IO ()
...
{-| __C declaration:__ @transformMeasurement@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_0e22183e51a42eab" transformMeasurement ::
     Ptr.Ptr Measurement
...
{-| __C declaration:__ @processWithCallbacks@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_9b4727ea289ff135" processWithCallbacks ::
...
{-| __C declaration:__ @registerHandler@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_aea76777f06b51ce" registerHandler ::
...
{-| __C declaration:__ @executePipeline@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_54fc81d3b44b84d5" executePipeline ::
     Ptr.Ptr Measurement
     {- ^ __C declaration:__ @data'@
     -}
...
{-| __C declaration:__ @runProcessor@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_4bb32ee774218053" runProcessor ::
     Ptr.Ptr Measurement
     {- ^ __C declaration:__ @data'@
     -}
  -> Ptr.Ptr Processor
...
{-| __C declaration:__ @processMeasurementWithValidation@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_f453b618c9ab0234" processMeasurementWithValidation ::
     Ptr.Ptr Measurement
     {- ^ __C declaration:__ @data'@
     -}
...
{-| __C declaration:__ @f@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_b68b2cffacc97c1d" f ::
     Ptr.FunPtr (Foo -> IO ())
...
{-| __C declaration:__ @f2@
    ...
    __exported by:__ @callbacks.h@
-}
foreign import ccall unsafe "hs_bindgen_test_callbacks_14361e995fb5684a" f2 ::
     Ptr.FunPtr (Foo2 -> IO ())
     {- ^ __C declaration:__ @handler@
     -}
  -> IO ()
