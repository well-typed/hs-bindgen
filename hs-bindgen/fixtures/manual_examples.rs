...
pub const descending_X: descending = 100;
pub const descending_Y: descending = 99;
pub const descending_Y_alias: descending = 99;
pub const descending_Z: descending = 98;
pub type descending = ::std::os::raw::c_uint;
