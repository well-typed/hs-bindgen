...
instance Data.Primitive.Types.Prim Config where
  ...
  indexByteArray# =
    \arr0 ->
      \i1 ->
        Config (Data.Primitive.Types.indexByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#))) (Data.Primitive.Types.indexByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)))
          ...
          \s3 ->
            case struct2 of
              Config config_x4 config_y5 ->
                case Data.Primitive.Types.writeByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#)) config_x4 s3 of
                  s6 ->
                    Data.Primitive.Types.writeByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)) config_y5 s6

  indexOffAddr# =
    \addr0 ->
      \i1 ->
        Config (Data.Primitive.Types.indexOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#))) (Data.Primitive.Types.indexOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)))
      ...
      \i1 ->
        \struct2 ->
          \s3 ->
            case struct2 of
              Config config_x4 config_y5 ->
                case Data.Primitive.Types.writeOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#)) config_x4 s3 of
                  s6 ->
                    Data.Primitive.Types.writeOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)) config_y5 s6
...
instance Data.Primitive.Types.Prim Inline_struct where
  ...
  indexByteArray# =
    \arr0 ->
      \i1 ->
        Inline_struct (Data.Primitive.Types.indexByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#))) (Data.Primitive.Types.indexByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)))
          ...
          \s3 ->
            case struct2 of
              Inline_struct inline_struct_x4 inline_struct_y5 ->
                case Data.Primitive.Types.writeByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#)) inline_struct_x4 s3 of
                  s6 ->
                    Data.Primitive.Types.writeByteArray# arr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)) inline_struct_y5 s6

  indexOffAddr# =
    \addr0 ->
      \i1 ->
        Inline_struct (Data.Primitive.Types.indexOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#))) (Data.Primitive.Types.indexOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)))
      ...
      \i1 ->
        \struct2 ->
          \s3 ->
            case struct2 of
              Inline_struct inline_struct_x4 inline_struct_y5 ->
                case Data.Primitive.Types.writeOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (0# :: Int#)) inline_struct_x4 s3 of
                  s6 ->
                    Data.Primitive.Types.writeOffAddr# addr0 ((+#) ((*#) (2# :: Int#) i1) (1# :: Int#)) inline_struct_y5 s6
