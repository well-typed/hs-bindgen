...
instance F.Storable AnonPoint where
  ...
  peek =
    \ptr0 ->
          pure AnonPoint
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"anonPoint_x") ptr0
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"anonPoint_y") ptr0
      ...
      \s1 ->
        case s1 of
          AnonPoint anonPoint_x2 anonPoint_y3 ->
               HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"anonPoint_x") ptr0 anonPoint_x2
            >> HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"anonPoint_y") ptr0 anonPoint_y3
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType AnonPoint) "anonPoint_x")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"anonPoint_x")
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType AnonPoint) "anonPoint_y")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"anonPoint_y")
...
instance F.Storable AnonPair where
  ...
  peek =
    \ptr0 ->
          pure AnonPair
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"anonPair_a") ptr0
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"anonPair_b") ptr0
      ...
      \s1 ->
        case s1 of
          AnonPair anonPair_a2 anonPair_b3 ->
               HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"anonPair_a") ptr0 anonPair_a2
            >> HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"anonPair_b") ptr0 anonPair_b3
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType AnonPair) "anonPair_a")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"anonPair_a")
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType AnonPair) "anonPair_b")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"anonPair_b")
