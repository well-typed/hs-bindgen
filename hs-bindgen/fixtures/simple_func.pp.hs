...
foreign import ccall safe "testmodule_erf" erf :: FC.CDouble
                                               -> IO FC.CDouble

foreign import ccall safe "testmodule_bad_fma" bad_fma :: FC.CDouble
                                                       -> FC.CDouble
                                                       -> FC.CDouble
                                                       -> IO FC.CDouble
...
foreign import ccall safe "testmodule_fun" fun :: FC.CChar
                                               -> FC.CDouble
                                               -> (IO FC.CInt)
