...
foreign import ccall safe "testmodule_makeToggle" makeToggle :: FC.CBool
                                                             -> IO Toggle

foreign import ccall safe "testmodule_toggleNext" toggleNext :: Toggle
                                                             -> IO FC.CBool

foreign import ccall safe "testmodule_releaseToggle" releaseToggle :: Toggle
                                                                   -> IO ()
...
foreign import ccall safe "testmodule_makeCounter" makeCounter :: FC.CInt
                                                               -> FC.CInt
                                                               -> (IO Counter)

foreign import ccall safe "testmodule_counterNext" counterNext :: Counter
                                                               -> IO FC.CInt

foreign import ccall safe "testmodule_releaseCounter" releaseCounter :: Counter
                                                                     -> IO ()
...
foreign import ccall safe "testmodule_makeVarCounter" makeVarCounter :: FC.CInt
                                                                     -> IO VarCounter

foreign import ccall safe "testmodule_varCounterNext" varCounterNext :: VarCounter
                                                                     -> FC.CInt
                                                                     -> (IO FC.CInt)

foreign import ccall safe "testmodule_releaseVarCounter" releaseVarCounter :: VarCounter
                                                                           -> IO ()
