[
          ...
          declHeaderInfo = Just
            HeaderInfo {
              headerMainHeaders = NE.fromList
                [
                  "declarations_required_for_scoping.h"],
              headerInclude =
              "declarations_required_for_scoping.h"},
          declComment = Nothing},
        declKind = Macro
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_declarations_required_for_scop_fcce70013c76ce8b",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimUnit)),
      foreignImportOrigName =
      "hs_bindgen_test_declarations_required_for_scop_b68b2cffacc97c1d",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_declarations_required_for_scop_c34fd33eedc1490d",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
