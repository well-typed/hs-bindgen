...
-- __unique:__ @test_edgecasesenum_as_array_size_Example_get_test_array@
hs_bindgen_30b94bcf7e387817 :: IO (HsBindgen.Runtime.ConstPtr.ConstPtr ((HsBindgen.Runtime.Array.KnownSize.Mutable.Array 1) FC.CChar))
...
-}
hs_bindgen_e30c033f156164cc :: HsBindgen.Runtime.ConstPtr.ConstPtr ((HsBindgen.Runtime.Array.KnownSize.Mutable.Array 1) FC.CChar)
hs_bindgen_e30c033f156164cc =
  GHC.IO.Unsafe.unsafePerformIO hs_bindgen_30b94bcf7e387817

{-# NOINLINE test_array #-}
test_array :: (HsBindgen.Runtime.Array.KnownSize.Mutable.Array 1) FC.CChar
test_array =
