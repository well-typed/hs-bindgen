[
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      foreignImportOrigName =
      "hs_bindgen_test_edgecasesdistilled_lib_1_29c178c31334688f",
      foreignImportCallConv =
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      foreignImportOrigName =
      "hs_bindgen_test_edgecasesdistilled_lib_1_efd27157959bd4b3",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
          concat
            [
              "int32_t hs_bindgen_test_edgecasesdistilled_lib_1_efd27157959bd4b3 (\n",
              "  a_type_t *arg1,\n",
              "  uint32_t arg2,\n",
              "  uint8_t *arg3\n",
              ")\n",
