...
{-| Array of known size
  ...
  __from C:__ @fun_1(int, int *)@
-}
foreign import ccall safe "hs_bindgen_test_array_93382555f3789d90" fun_1_ptr
  :: F.FunPtr (FC.CInt -> ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt) -> IO FC.CInt)
...
{-| Array of known size, typedef
  ...
  __from C:__ @fun_2(int *)@
-}
foreign import ccall safe "hs_bindgen_test_array_4afbbb57351eed54" fun_2_ptr
  :: F.FunPtr (Triplet -> IO FC.CInt)
...
{-| Array of unknown size
  ...
  __from C:__ @fun_3(int *)@
-}
foreign import ccall safe "hs_bindgen_test_array_3f63bc5e6ab55421" fun_3_ptr
  :: F.FunPtr ((HsBindgen.Runtime.IncompleteArray.IncompleteArray FC.CInt) -> IO FC.CInt)
...
{-| Array of unknown size, typedef
  ...
  __from C:__ @fun_4(int *)@
-}
foreign import ccall safe "hs_bindgen_test_array_41b8a0c3ba0ec9e1" fun_4_ptr
  :: F.FunPtr (List -> IO FC.CInt)
...
{-| Multi-dimensional array of known size
  ...
  __from C:__ @fun_5(int (*)[3])@
-}
foreign import ccall safe "hs_bindgen_test_array_d1abe7db131e3b19" fun_5_ptr
  :: F.FunPtr (((HsBindgen.Runtime.ConstantArray.ConstantArray 4) ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)) -> IO FC.CInt)
...
{-| Multi-dimensional array of known size, typedef
  ...
  __from C:__ @fun_6(int (*)[3])@
-}
foreign import ccall safe "hs_bindgen_test_array_7c972f297f91d659" fun_6_ptr
  :: F.FunPtr (Matrix -> IO FC.CInt)
...
{-| Multi-dimensional array of unknown size
  ...
  __from C:__ @fun_7(int (*)[3])@
-}
foreign import ccall safe "hs_bindgen_test_array_6b3f3d6a5093e5cc" fun_7_ptr
  :: F.FunPtr ((HsBindgen.Runtime.IncompleteArray.IncompleteArray ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)) -> IO FC.CInt)
...
{-| Multi-dimensional array of unknown size, typedef
  ...
  __from C:__ @fun_8(int (*)[3])@
-}
foreign import ccall safe "hs_bindgen_test_array_c26b88304638d612" fun_8_ptr
  :: F.FunPtr (Tripletlist -> IO FC.CInt)
...
{-| Array of known size
  ...
  __from C:__ @fun_9()@
-}
foreign import ccall safe "hs_bindgen_test_array_a9f13cbd15057404" fun_9_ptr
  :: F.FunPtr (IO (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)))
...
{-| Array of known size, typedef
  ...
  __from C:__ @fun_10()@
-}
foreign import ccall safe "hs_bindgen_test_array_e0071a6c4a5b4bfc" fun_10_ptr
  :: F.FunPtr (IO (F.Ptr Triplet))
...
{-| Array of unknown size
  ...
  __from C:__ @fun_11()@
-}
foreign import ccall safe "hs_bindgen_test_array_c242f0482c8c80e3" fun_11_ptr
  :: F.FunPtr (IO (F.Ptr (HsBindgen.Runtime.IncompleteArray.IncompleteArray FC.CInt)))
...
{-| Array of unknown size, typedef
  ...
  __from C:__ @fun_12()@
-}
foreign import ccall safe "hs_bindgen_test_array_29c3e7c11a23c44f" fun_12_ptr
  :: F.FunPtr (IO (F.Ptr List))
...
{-| Multi-dimensional array of known size
  ...
  __from C:__ @fun_13()@
-}
foreign import ccall safe "hs_bindgen_test_array_c30eaebfadb99814" fun_13_ptr
  :: F.FunPtr (IO (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 4) ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt))))
...
{-| Multi-dimensional array of known size, typedef
  ...
  __from C:__ @fun_14()@
-}
foreign import ccall safe "hs_bindgen_test_array_51fe3407a9c308d6" fun_14_ptr
  :: F.FunPtr (IO (F.Ptr Matrix))
...
{-| Multi-dimensional array of unknown size
  ...
  __from C:__ @fun_15()@
-}
foreign import ccall safe "hs_bindgen_test_array_74204588fdafa1a9" fun_15_ptr
  :: F.FunPtr (IO (F.Ptr (HsBindgen.Runtime.IncompleteArray.IncompleteArray ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt))))
...
{-| Multi-dimensional array of unknown size, typedef
  ...
  __from C:__ @fun_16()@
-}
foreign import ccall safe "hs_bindgen_test_array_58a2b1249489d65b" fun_16_ptr
  :: F.FunPtr (IO (F.Ptr Tripletlist))
