...
-}
foreign import ccall safe "test_internal_fun_1" fun_1_wrapper :: FC.CInt -> (F.Ptr FC.CInt) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_2" fun_2_wrapper :: (F.Ptr FC.CInt) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_3" fun_3_wrapper :: (F.Ptr FC.CInt) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_4" fun_4_wrapper :: (F.Ptr FC.CInt) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_5" fun_5_wrapper :: (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_6" fun_6_wrapper :: (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_7" fun_7_wrapper :: (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)) -> IO FC.CInt
...
-}
foreign import ccall safe "test_internal_fun_8" fun_8_wrapper :: (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)) -> IO FC.CInt
...
{-| Array of known size
  ...
  __from C:__ @fun_9()@
-}
foreign import ccall safe "test_internal_fun_9" fun_9 :: IO (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt))

{-| Array of known size, typedef

  __from C:__ @fun_10()@
-}
foreign import ccall safe "test_internal_fun_10" fun_10 :: IO (F.Ptr Triplet)

{-| Array of unknown size

  __from C:__ @fun_11()@
-}
foreign import ccall safe "test_internal_fun_11" fun_11 :: IO (F.Ptr (HsBindgen.Runtime.IncompleteArray.IncompleteArray FC.CInt))

{-| Array of unknown size, typedef

  __from C:__ @fun_12()@
-}
foreign import ccall safe "test_internal_fun_12" fun_12 :: IO (F.Ptr List)

{-| Multi-dimensional array of known size

  __from C:__ @fun_13()@
-}
foreign import ccall safe "test_internal_fun_13" fun_13 :: IO (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 4) ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)))

{-| Multi-dimensional array of known size, typedef

  __from C:__ @fun_14()@
-}
foreign import ccall safe "test_internal_fun_14" fun_14 :: IO (F.Ptr Matrix)

{-| Multi-dimensional array of unknown size

  __from C:__ @fun_15()@
-}
foreign import ccall safe "test_internal_fun_15" fun_15 :: IO (F.Ptr (HsBindgen.Runtime.IncompleteArray.IncompleteArray ((HsBindgen.Runtime.ConstantArray.ConstantArray 3) FC.CInt)))

{-| Multi-dimensional array of unknown size, typedef

  __from C:__ @fun_16()@
-}
foreign import ccall safe "test_internal_fun_16" fun_16 :: IO (F.Ptr Tripletlist)
