[
          ...
          declHeaderInfo = Just
            HeaderInfo {
              headerMainHeaders = NE.fromList
                [
                  "program-analysis/program_slicing_selection.h"],
              headerInclude =
              "program-analysis/program_slicing_selection.h"},
          declComment = Nothing},
        declKind = Enum
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_programanalysisprogram_slici_13b0ed81415a625a",
        ...
        (HsIO
          (HsTypRef
            (Name
              ...
              "FileOperationStatus"))),
      foreignImportOrigName =
      "hs_bindgen_test_programanalysisprogram_slici_3ade0bc94fb1ed45",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
