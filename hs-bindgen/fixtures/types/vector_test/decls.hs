[
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typesvector_test_c8cd49ec7dbcac25",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "vector *hs_bindgen_test_typesvector_test_c8cd49ec7dbcac25 (\n",
              "  double arg1,\n",
              "  double arg2\n",
              ")\n",
              "{\n",
          ...
          (HsPtr
            (HsTypRef
              (Name
                ...
                "Vector")))),
      foreignImportOrigName =
      "hs_bindgen_test_typesvector_test_30a7381111c0131a",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "vector *hs_bindgen_test_typesvector_test_30a7381111c0131a (\n",
              "  double arg1,\n",
              "  double arg2\n",
              ")\n",
              "{\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_typesvector_test_7672b9e7f001c998",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
