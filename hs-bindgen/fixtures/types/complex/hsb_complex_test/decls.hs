[
              ...
              commentHeaderInfo = Just
                HeaderInfo {
                  headerMainHeaders = NE.fromList
                    [
                      "types/complex/hsb_complex_test.h"],
                  headerInclude =
                  "types/complex/hsb_complex_test.h"},
              commentChildren = []}},
        Field {
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typescomplexhsb_complex_test_b84ea846e04d5fd6",
      ...
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          ...
          concat
            [
              "void hs_bindgen_test_typescomplexhsb_complex_test_b84ea846e04d5fd6 (\n",
              "  float _Complex *arg1,\n",
              "  float _Complex *arg2,\n",
              "  float _Complex *arg3\n",
              ")\n",
    ...
    ForeignImportDecl {
      ...
      HeapResultType
        (HsPtr
          (HsComplexType HsPrimCDouble)),
      foreignImportOrigName =
      "hs_bindgen_test_typescomplexhsb_complex_test_8dd079d1707c36b3",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
          concat
            [
              "void hs_bindgen_test_typescomplexhsb_complex_test_8dd079d1707c36b3 (\n",
    ...
    ForeignImportDecl {
      ...
      HeapResultType
        (HsPtr
          (HsComplexType HsPrimCFloat)),
      foreignImportOrigName =
      "hs_bindgen_test_typescomplexhsb_complex_test_5b05fdb10924da35",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
    ...
    ForeignImportDecl {
      ...
      HeapResultType
        (HsPtr
          (HsComplexType HsPrimCDouble)),
      foreignImportOrigName =
      "hs_bindgen_test_typescomplexhsb_complex_test_59f299d5d991ed72",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
