[
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typesqualifierstype_qualifie_b42fb41209c21d6e",
      ...
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          ...
          concat
            [
              "_Bool hs_bindgen_test_typesqualifierstype_qualifie_b42fb41209c21d6e (\n",
              "  char const **arg1,\n",
              "  size_t arg2\n",
              ")\n",
              "{\n",
              ...
              "}"],
          capiWrapperImport =
          "types/qualifiers/type_qualifiers.h"},
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimCBool)),
      foreignImportOrigName =
      "hs_bindgen_test_typesqualifierstype_qualifie_41af05ef1797fa6d",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
