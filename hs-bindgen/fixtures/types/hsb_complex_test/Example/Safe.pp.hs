...
-}
foreign import ccall safe "hs_bindgen_test_typeshsb_complex_test_b84ea846e04d5fd6" multiply_complex_f_wrapper ::
...
-}
foreign import ccall safe "hs_bindgen_test_typeshsb_complex_test_8dd079d1707c36b3" add_complex_wrapper ::
