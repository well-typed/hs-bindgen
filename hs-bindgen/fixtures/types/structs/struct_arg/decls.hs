[
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typesstructsstruct_arg_61dfa2c4506feb8f",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_022cc8107f565c95",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_4d9304280cca3098",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_f39687b254852452",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimCInt)),
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_409d8c948bf989f6",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
          concat
            [
              "signed int hs_bindgen_test_typesstructsstruct_arg_409d8c948bf989f6 (\n",
              "  struct thing *arg1\n",
              ")\n",
              "{\n",
              "  return thing_fun_1(*arg1);\n",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_2d20059791239ef2",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
          concat
            [
              "void hs_bindgen_test_typesstructsstruct_arg_2d20059791239ef2 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2\n",
              ")\n",
              "{\n",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_ce442967da2c37cd",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
          concat
            [
              "void hs_bindgen_test_typesstructsstruct_arg_ce442967da2c37cd (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2,\n",
              "  double arg3,\n",
              "  struct thing *arg4\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimCChar)),
      foreignImportOrigName =
      "hs_bindgen_test_typesstructsstruct_arg_e8bc8fce45854092",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
          concat
            [
              "char hs_bindgen_test_typesstructsstruct_arg_e8bc8fce45854092 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2,\n",
              "  double arg3\n",
              ")\n",
