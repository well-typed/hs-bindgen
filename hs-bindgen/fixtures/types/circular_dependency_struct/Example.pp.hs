...
{-| __C declaration:__ @b@
    ...
    __defined at:__ @types\/circular_dependency_struct.h:3:8@

    __exported by:__ @types\/circular_dependency_struct.h@
-}
data B = B
  { b_toA :: Ptr.Ptr A
    {- ^ __C declaration:__ @toA@

         __defined at:__ @types\/circular_dependency_struct.h:4:13@
...
{-| __C declaration:__ @a@
    ...
    __defined at:__ @types\/circular_dependency_struct.h:7:8@
...
data A = A
  { a_toB :: B
    {- ^ __C declaration:__ @toB@
         ...
         __defined at:__ @types\/circular_dependency_struct.h:8:12@
