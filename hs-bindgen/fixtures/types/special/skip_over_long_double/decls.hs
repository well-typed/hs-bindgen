[
              ...
              commentHeaderInfo = Just
                HeaderInfo {
                  headerMainHeaders = NE.fromList
                    [
                      "types/special/skip_over_long_double.h"],
                  headerInclude =
                  "types/special/skip_over_long_double.h"},
              commentChildren = []}}],
      structOrigin = Just
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typesspecialskip_over_long_d_fb32cb593bc1f7b8",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimUnit)),
      foreignImportOrigName =
      "hs_bindgen_test_typesspecialskip_over_long_d_5ebf8088e71802cc",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
