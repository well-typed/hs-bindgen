[
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typesskip_over_long_double_fb32cb593bc1f7b8",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimUnit)),
      foreignImportOrigName =
      "hs_bindgen_test_typesskip_over_long_double_5ebf8088e71802cc",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition =
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_typesskip_over_long_double_d1bf59c1516f6bfa",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
