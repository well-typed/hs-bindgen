[
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      "hs_bindgen_test_typesstruct_arg_61dfa2c4506feb8f",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "signed int hs_bindgen_test_typesstruct_arg_61dfa2c4506feb8f (\n",
              "  struct thing *arg1\n",
              ")\n",
              "{\n",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_022cc8107f565c95",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "void hs_bindgen_test_typesstruct_arg_022cc8107f565c95 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2\n",
              ")\n",
              "{\n",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_4d9304280cca3098",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "void hs_bindgen_test_typesstruct_arg_4d9304280cca3098 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2,\n",
              "  double arg3,\n",
              "  struct thing *arg4\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_f39687b254852452",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "char hs_bindgen_test_typesstruct_arg_f39687b254852452 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2,\n",
              "  double arg3\n",
              ")\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimCInt)),
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_409d8c948bf989f6",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "signed int hs_bindgen_test_typesstruct_arg_409d8c948bf989f6 (\n",
              "  struct thing *arg1\n",
              ")\n",
              "{\n",
              "  return thing_fun_1(*arg1);\n",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_2d20059791239ef2",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "void hs_bindgen_test_typesstruct_arg_2d20059791239ef2 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2\n",
              ")\n",
              "{\n",
        ...
        (HsPtr
          (HsTypRef
            (Name
              ...
              "Thing"))),
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_ce442967da2c37cd",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "void hs_bindgen_test_typesstruct_arg_ce442967da2c37cd (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2,\n",
              "  double arg3,\n",
              "  struct thing *arg4\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      ...
      NormalResultType
        (HsIO (HsPrimType HsPrimCChar)),
      foreignImportOrigName =
      "hs_bindgen_test_typesstruct_arg_e8bc8fce45854092",
      foreignImportCallConv =
      CallConvUserlandCAPI
        UserlandCapiWrapper {
          capiWrapperDefinition = concat
            [
              "char hs_bindgen_test_typesstruct_arg_e8bc8fce45854092 (\n",
              "  signed int arg1,\n",
              "  struct thing *arg2,\n",
              "  double arg3\n",
              ")\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_typesstruct_arg_c5f0c295b311010a",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
        ...
        UserlandCapiWrapper {
          ...
          concat
            [
              "/* get_thing_fun_1_ptr */\n",
              "__attribute__ ((const))\n",
              "signed int (*hs_bindgen_test_typesstruct_arg_c5f0c295b311010a (void)) (\n",
              "  struct thing arg1\n",
              ")\n",
              "{\n",
              "  return &thing_fun_1;\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_typesstruct_arg_24edf6600396b62a",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
        ...
        UserlandCapiWrapper {
          ...
          concat
            [
              "/* get_thing_fun_2_ptr */\n",
              "__attribute__ ((const))\n",
              "struct thing (*hs_bindgen_test_typesstruct_arg_24edf6600396b62a (void)) (\n",
              "  signed int arg1\n",
              ")\n",
              "{\n",
              "  return &thing_fun_2;\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_typesstruct_arg_29a42b48992cd0bf",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
        ...
        UserlandCapiWrapper {
          ...
          concat
            [
              ...
              "__attribute__ ((const))\n",
              "struct thing (*hs_bindgen_test_typesstruct_arg_29a42b48992cd0bf (void)) (\n",
              "  signed int arg1,\n",
              "  struct thing arg2,\n",
              "  double arg3\n",
              ")\n",
  ...
  DeclForeignImport
    ForeignImportDecl {
      foreignImportName = Name
        "@NsVar"
        "hs_bindgen_test_typesstruct_arg_0d6597dfc03e312f",
      foreignImportParameters = [],
      foreignImportResultType =
      NormalResultType
        (HsIO
        ...
        UserlandCapiWrapper {
          ...
          concat
            [
              ...
              "__attribute__ ((const))\n",
              "char (*hs_bindgen_test_typesstruct_arg_0d6597dfc03e312f (void)) (\n",
              "  signed int arg1,\n",
              "  struct thing arg2,\n",
              "  double arg3\n",
              ")\n",
