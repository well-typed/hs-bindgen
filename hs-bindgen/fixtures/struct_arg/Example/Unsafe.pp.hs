...
-}
foreign import ccall unsafe "hs_bindgen_test_struct_arg_409d8c948bf989f6" thing_fun_1_wrapper ::
     Ptr.Ptr Thing
  -> IO FC.CInt
...
-}
foreign import ccall unsafe "hs_bindgen_test_struct_arg_2d20059791239ef2" thing_fun_2_wrapper ::
     FC.CInt
  -> Ptr.Ptr Thing
  -> IO ()
...
-}
foreign import ccall unsafe "hs_bindgen_test_struct_arg_ce442967da2c37cd" thing_fun_3a_wrapper ::
     FC.CInt
  -> Ptr.Ptr Thing
  -> FC.CDouble
  -> Ptr.Ptr Thing
...
-}
foreign import ccall unsafe "hs_bindgen_test_struct_arg_e8bc8fce45854092" thing_fun_3b_wrapper ::
     FC.CInt
  -> Ptr.Ptr Thing
  -> FC.CDouble
  -> IO FC.CChar
