...
{-| __C declaration:__ @struct S@
    ...
    __defined at:__ @binding-specs\/fun_arg\/struct.h:1:8@
...
data S = S
  { s_x :: FC.CInt
    {- ^ __C declaration:__ @x@
         ...
         __defined at:__ @binding-specs\/fun_arg\/struct.h:1:16@
...
instance F.Storable S where
  ...
  peek =
    \ptr0 ->
          pure S
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"s_x") ptr0
  ...
  poke =
    \ptr0 ->
      \s1 ->
        case s1 of
          S s_x2 ->
            HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"s_x") ptr0 s_x2
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType S) "s_x")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"s_x")
