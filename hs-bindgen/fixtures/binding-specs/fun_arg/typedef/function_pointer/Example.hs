...
hs_bindgen_1cabb32c661d9a0e =
  \fun0 ->
    P.fmap HsBindgen.Runtime.Internal.HasFFIType.castFunPtrFromFFIType (hs_bindgen_1cabb32c661d9a0e_base (HsBindgen.Runtime.Internal.HasFFIType.toFFIType fun0))
