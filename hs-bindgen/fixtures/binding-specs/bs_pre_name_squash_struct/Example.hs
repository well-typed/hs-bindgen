...
{-| __C declaration:__ @struct foo@
    ...
    __defined at:__ @binding-specs\/bs_pre_name_squash_struct.h 1:16@

    __exported by:__ @binding-specs\/bs_pre_name_squash_struct.h@
-}
data Hoge = Hoge
  { hoge_x :: FC.CInt
    {- ^ __C declaration:__ @x@

         __defined at:__ @binding-specs\/bs_pre_name_squash_struct.h 1:26@
  ...
  , hoge_y :: FC.CInt
    {- ^ __C declaration:__ @y@
         ...
         __defined at:__ @binding-specs\/bs_pre_name_squash_struct.h 1:29@
...
instance F.Storable Hoge where
  ...
  peek =
    \ptr0 ->
          pure Hoge
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"hoge_x") ptr0
      <*> HsBindgen.Runtime.HasCField.peekCField (Data.Proxy.Proxy @"hoge_y") ptr0
      ...
      \s1 ->
        case s1 of
          Hoge hoge_x2 hoge_y3 ->
               HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"hoge_x") ptr0 hoge_x2
            >> HsBindgen.Runtime.HasCField.pokeCField (Data.Proxy.Proxy @"hoge_y") ptr0 hoge_y3
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType Hoge) "hoge_x")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"hoge_x")
...
instance ( TyEq ty ((HsBindgen.Runtime.HasCField.CFieldType Hoge) "hoge_y")
  ...
  getField =
    HsBindgen.Runtime.HasCField.ptrToCField (Data.Proxy.Proxy @"hoge_y")
