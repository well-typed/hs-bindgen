...
-}
foreign import ccall unsafe "hs_bindgen_f9f2776d121db261" transpose_wrapper_base ::
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_e43b4d44aa0abd14" pretty_print_triplets_base ::
     Ptr.Ptr Void
  -> IO ()
