...
$(HsBindgen.Runtime.Prelude.addCSource (HsBindgen.Runtime.Prelude.unlines
  ...
  , "  return &apply2;"
  , "}"
  , "/* ExampleNothingget_apply1_pointer_arg_ptr */"
  , "__attribute__ ((const))"
  ...
  , "}"
  , "/* ExampleNothingget_apply1_nopointer_arg_ptr */"
  , "__attribute__ ((const))"
  ...
  , "}"
  , "/* ExampleNothingget_apply1_nopointer_res_ptr */"
  , "__attribute__ ((const))"
