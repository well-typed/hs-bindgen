...
square_unsafe ::
     FC.CInt
  -> IO FC.CInt
square_unsafe = hs_bindgen_db669c022bc12e81
...
plus_unsafe ::
  ...
  -> FC.CInt
  -> IO FC.CInt
plus_unsafe = hs_bindgen_0bb46b9dde136391
...
apply1_unsafe ::
  ...
  -> IO FC.CInt
apply1_unsafe = hs_bindgen_3ff551d60859d359
...
apply2_unsafe ::
  ...
  -> IO FC.CInt
apply2_unsafe = hs_bindgen_4c92d113161d27cf
...
__exported by:__ @manual\/function_pointers.h@
-}
apply1_nopointer_res_unsafe :: IO (Ptr.FunPtr ((Ptr.FunPtr Int2int) -> FC.CInt -> IO FC.CInt))
apply1_nopointer_res_unsafe =
  hs_bindgen_99a8340e6e6029c5
