...
foreign import ccall unsafe "hs_bindgen_test_complex_test_63b5c3b086238e05" hs_bindgen_test_complex_test_63b5c3b086238e05
  :: IO (F.Ptr (Data.Complex.Complex FC.CFloat))

{-# NOINLINE global_complex_float_ptr #-}

global_complex_float_ptr :: F.Ptr (Data.Complex.Complex FC.CFloat)
...
foreign import ccall unsafe "hs_bindgen_test_complex_test_2ed91230aab82376" hs_bindgen_test_complex_test_2ed91230aab82376
  :: IO (F.Ptr (Data.Complex.Complex FC.CDouble))

{-# NOINLINE global_complex_double_ptr #-}

global_complex_double_ptr :: F.Ptr (Data.Complex.Complex FC.CDouble)
...
global_complex_float_flipped_ptr :: F.Ptr (Data.Complex.Complex FC.CFloat)
...
global_complex_double_flipped_ptr :: F.Ptr (Data.Complex.Complex FC.CDouble)
...
const_complex_float_ptr :: F.Ptr (Data.Complex.Complex FC.CFloat)
...
const_complex_double_ptr :: F.Ptr (Data.Complex.Complex FC.CDouble)
...
volatile_complex_float_ptr :: F.Ptr (Data.Complex.Complex FC.CFloat)
...
volatile_complex_double_ptr :: F.Ptr (Data.Complex.Complex FC.CDouble)
...
foreign import ccall safe "hs_bindgen_test_complex_test_34bc3d67e3017a3b" multiply_complex_f_wrapper
  :: F.Ptr (Data.Complex.Complex FC.CFloat)
...
foreign import ccall unsafe "hs_bindgen_test_complex_test_ddb79318dfa04cfe" hs_bindgen_test_complex_test_ddb79318dfa04cfe
  :: IO (F.FunPtr ((Data.Complex.Complex FC.CFloat) -> (Data.Complex.Complex FC.CFloat) -> IO (Data.Complex.Complex FC.CFloat)))

{-# NOINLINE multiply_complex_f_ptr #-}

multiply_complex_f_ptr :: F.FunPtr ((Data.Complex.Complex FC.CFloat) -> (Data.Complex.Complex FC.CFloat) -> IO (Data.Complex.Complex FC.CFloat))
...
foreign import ccall safe "hs_bindgen_test_complex_test_c287eef299676eff" add_complex_wrapper
  :: F.Ptr (Data.Complex.Complex FC.CDouble)
     {- ^ __C declaration:__ @a@
     -}
  -> F.Ptr (Data.Complex.Complex FC.CDouble)
     {- ^ __C declaration:__ @b@
...
foreign import ccall unsafe "hs_bindgen_test_complex_test_e40839114bbc4cf0" hs_bindgen_test_complex_test_e40839114bbc4cf0
  :: IO (F.FunPtr ((Data.Complex.Complex FC.CDouble) -> (Data.Complex.Complex FC.CDouble) -> IO (Data.Complex.Complex FC.CDouble)))

{-# NOINLINE add_complex_ptr #-}

add_complex_ptr :: F.FunPtr ((Data.Complex.Complex FC.CDouble) -> (Data.Complex.Complex FC.CDouble) -> IO (Data.Complex.Complex FC.CDouble))
add_complex_ptr =
...
foreign import ccall unsafe "hs_bindgen_test_complex_test_c0e2d238404ba14c" hs_bindgen_test_complex_test_c0e2d238404ba14c
  :: IO (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 10) (Data.Complex.Complex FC.CFloat)))

{-# NOINLINE complex_float_array_ptr #-}

complex_float_array_ptr :: F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 10) (Data.Complex.Complex FC.CFloat))
...
foreign import ccall unsafe "hs_bindgen_test_complex_test_43f5f653ea4bf18c" hs_bindgen_test_complex_test_43f5f653ea4bf18c
  :: IO (F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 10) (Data.Complex.Complex FC.CDouble)))

{-# NOINLINE complex_double_array_ptr #-}

complex_double_array_ptr :: F.Ptr ((HsBindgen.Runtime.ConstantArray.ConstantArray 10) (Data.Complex.Complex FC.CDouble))
