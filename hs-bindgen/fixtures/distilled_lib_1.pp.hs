...
foreign import ccall safe "hs_bindgen_test_distilled_lib_1_4a8e737205def139" some_fun_ptr
  :: F.FunPtr ((F.Ptr A_type_t) -> HsBindgen.Runtime.Prelude.Word32 -> (HsBindgen.Runtime.IncompleteArray.IncompleteArray HsBindgen.Runtime.Prelude.Word8) -> IO HsBindgen.Runtime.Prelude.Int32)
