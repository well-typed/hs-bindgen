...
-}
foreign import ccall unsafe "hs_bindgen_e6085a910ba41ecb" process_data_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> (Ptr.Ptr HsBindgen.Runtime.Prelude.Word8) -> (Ptr.Ptr HsBindgen.Runtime.Prelude.CSize) -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_c27e893aea0b0a77" process_file_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr FC.CChar) -> IO FC.CBool)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_bc1b0e25a72f4ec0" calculate_value_base ::
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_09abc3cb74562964" html_example_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (FC.CInt -> IO FC.CBool)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_47cba1a95d265f84" list_example_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr (Ptr.Ptr FC.CChar)) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CBool)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_e065fc013e4eccd6" dangerous_function_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr Void) -> IO (Ptr.Ptr Void))
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_bc4f7e24b2ad4ace" detailed_return_codes_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr FC.CChar) -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_8deec146389ae8b3" old_function_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (FC.CInt -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_da2dcc1473935665" versioned_function_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (FC.CInt -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_97c1191917e6eece" process_buffer_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_58253bb560dc3eb3" my_memcpy_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr Void) -> (Ptr.Ptr Void) -> HsBindgen.Runtime.Prelude.CSize -> IO (Ptr.Ptr Void))
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_44dd19b16ee38e5b" double_value_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (FC.CInt -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_fd6fce7c8d8b2f79" complex_function_base ::
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_dd36c8b317ccfcc4" hash_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType ((Ptr.Ptr FC.CChar) -> IO FC.CInt)
...
{-| This is an internal function.
-}
foreign import ccall unsafe "hs_bindgen_6875e30a7fe8d30a" square_base ::
     HsBindgen.Runtime.HasBaseForeignType.BaseForeignType (FC.CInt -> FC.CInt)
