...
-}
foreign import ccall unsafe "hs_bindgen_test_decls_in_signature_35c28995abc46de4" normal_wrapper ::
     Ptr.Ptr Opaque
  -> Ptr.Ptr Outside
  -> Ptr.Ptr Outside
  -> IO ()
...
-}
foreign import ccall unsafe "hs_bindgen_test_decls_in_signature_c1788128a5b1c813" f1_wrapper ::
...
-}
foreign import ccall unsafe "hs_bindgen_test_decls_in_signature_14361e995fb5684a" f2_wrapper ::
     Ptr.Ptr Named_union
  -> IO ()
