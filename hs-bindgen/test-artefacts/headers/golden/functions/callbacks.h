...
// ----------------------------------------------------------------------------
// Callbacks in a global variable
// ----------------------------------------------------------------------------
typedef int A;
extern void (*globalVar[3])(A);

// ----------------------------------------------------------------------------
// Callbacks in a struct field
// ----------------------------------------------------------------------------
typedef int B;
struct S {
  void (* const fn)(B);
...
// ----------------------------------------------------------------------------
// Nested callback in a typedef
// ----------------------------------------------------------------------------
typedef int D;
typedef void (T)(void(*callback)(D));
