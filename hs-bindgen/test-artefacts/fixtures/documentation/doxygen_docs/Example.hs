...
deriving via Struct.IsStructViaReadRaw Config_t instance Struct.IsStruct Config_t
...
deriving via Struct.IsStructViaReadRaw Data_union_t_as_parts instance Struct.IsStruct Data_union_t_as_parts
...
deriving via Struct.IsStructViaReadRaw Bitfield_t instance Struct.IsStruct Bitfield_t
...
deriving via Struct.IsStructViaReadRaw Flexible_array_Aux instance Struct.IsStruct Flexible_array_Aux
...
deriving via Struct.IsStructViaReadRaw Dyn_array_t instance Struct.IsStruct Dyn_array_t
...
deriving via Struct.IsStructViaReadRaw Named_inner instance Struct.IsStruct Named_inner
...
deriving via Struct.IsStructViaReadRaw Named_outer instance Struct.IsStruct Named_outer
...
deriving via Struct.IsStructViaReadRaw Deep_mid instance Struct.IsStruct Deep_mid
...
deriving via Struct.IsStructViaReadRaw Deep_outer instance Struct.IsStruct Deep_outer
...
deriving via Struct.IsStructViaReadRaw Unnamed_field_t_anon'ua instance Struct.IsStruct Unnamed_field_t_anon'ua
...
deriving via Struct.IsStructViaReadRaw Unnamed_field_t instance Struct.IsStruct Unnamed_field_t
