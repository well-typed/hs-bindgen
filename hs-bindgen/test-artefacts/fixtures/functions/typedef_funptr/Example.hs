...
deriving via Struct.IsStructViaReadRaw Driver instance Struct.IsStruct Driver
...
deriving via Struct.IsStructViaReadRaw Bare instance Struct.IsStruct Bare
