...
deriving via Struct.IsStructViaReadRaw Another_typedef_struct_t instance Struct.IsStruct Another_typedef_struct_t
...
deriving via Struct.IsStructViaReadRaw A_typedef_struct_t instance Struct.IsStruct A_typedef_struct_t
