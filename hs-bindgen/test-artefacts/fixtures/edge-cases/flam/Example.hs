...
deriving via Struct.IsStructViaReadRaw Pascal_Aux instance Struct.IsStruct Pascal_Aux
...
deriving via Struct.IsStructViaReadRaw Foo_bar instance Struct.IsStruct Foo_bar
...
deriving via Struct.IsStructViaReadRaw Foo_Aux instance Struct.IsStruct Foo_Aux
...
deriving via Struct.IsStructViaReadRaw Diff_Aux instance Struct.IsStruct Diff_Aux
...
deriving via Struct.IsStructViaReadRaw Triplets_Aux instance Struct.IsStruct Triplets_Aux
