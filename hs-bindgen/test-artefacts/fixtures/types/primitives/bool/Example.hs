...
deriving via Struct.IsStructViaReadRaw Bools1 instance Struct.IsStruct Bools1
...
deriving via Struct.IsStructViaReadRaw Bools2 instance Struct.IsStruct Bools2
...
deriving via Struct.IsStructViaReadRaw Bools3 instance Struct.IsStruct Bools3
