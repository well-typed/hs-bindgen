...
hs_bindgen_8bf2d89ca41997fb =
  BG.unsafePerformIO hs_bindgen_bb40525ba9109d7a

{-# NOINLINE i #-}
i :: I
i =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_8bf2d89ca41997fb)
...
hs_bindgen_0e876abf0fe9e3b2 =
  BG.unsafePerformIO hs_bindgen_e02c667254de325e

{-# NOINLINE s #-}
s :: S
s =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_0e876abf0fe9e3b2)
...
hs_bindgen_b7bdf87ddb6b9a5b =
  BG.unsafePerformIO hs_bindgen_db442d4a677f346c

{-# NOINLINE u #-}
u :: U
u =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_b7bdf87ddb6b9a5b)
...
hs_bindgen_fa2424d094d91a33 =
  BG.unsafePerformIO hs_bindgen_f8e0ac7d2c94db95

{-# NOINLINE e #-}
e :: E
e =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_fa2424d094d91a33)
...
hs_bindgen_d7dd4362406f73a6 =
  BG.unsafePerformIO hs_bindgen_da8e11a66011da3a

{-# NOINLINE ti #-}
ti :: TI
ti =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_d7dd4362406f73a6)
...
hs_bindgen_cd3e2d14ae82b6fc =
  BG.unsafePerformIO hs_bindgen_10a3457a0f6b2036

{-# NOINLINE ts #-}
ts :: TS
ts =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_cd3e2d14ae82b6fc)
...
hs_bindgen_2d9684fc851b0766 =
  BG.unsafePerformIO hs_bindgen_ded2bbcd5f7b0513

{-# NOINLINE tu #-}
tu :: TU
tu =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_2d9684fc851b0766)
...
hs_bindgen_200eaed7c3fb420d =
  BG.unsafePerformIO hs_bindgen_1b4b0fa82bacf9cc

{-# NOINLINE te #-}
te :: TE
te =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_200eaed7c3fb420d)
...
hs_bindgen_1fbea465b2793d07 =
  BG.unsafePerformIO hs_bindgen_b8067bbfe8dc188e

{-# NOINLINE tti #-}
tti :: TTI
tti =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_1fbea465b2793d07)
...
hs_bindgen_f23f17df17b3fe36 =
  BG.unsafePerformIO hs_bindgen_6ce6ca09ed64a420

{-# NOINLINE tts #-}
tts :: TTS
tts =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_f23f17df17b3fe36)
...
hs_bindgen_45ab2258853f641d =
  BG.unsafePerformIO hs_bindgen_5d4569e6c5a642c0

{-# NOINLINE ttu #-}
ttu :: TTU
ttu =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_45ab2258853f641d)
...
hs_bindgen_0956779e634e3dd5 =
  BG.unsafePerformIO hs_bindgen_cb44d6db796abc21

{-# NOINLINE tte #-}
tte :: TTE
tte =
  BG.unsafePerformIO (PtrConst.peek hs_bindgen_0956779e634e3dd5)
