...
deriving via Struct.IsStructViaReadRaw Foo instance Struct.IsStruct Foo
...
deriving via Struct.IsStructViaReadRaw Bar instance Struct.IsStruct Bar
...
deriving via Struct.IsStructViaReadRaw Ex3_ex3_struct instance Struct.IsStruct Ex3_ex3_struct
...
deriving via Struct.IsStructViaReadRaw Ex3 instance Struct.IsStruct Ex3
...
deriving via Struct.IsStructViaReadRaw Ex4_odd instance Struct.IsStruct Ex4_odd
...
deriving via Struct.IsStructViaReadRaw Ex4_even instance Struct.IsStruct Ex4_even
