...
deriving via Struct.IsStructViaReadRaw Linked_list_A_t instance Struct.IsStruct Linked_list_A_t
...
deriving via Struct.IsStructViaReadRaw Linked_list_B_t instance Struct.IsStruct Linked_list_B_t
