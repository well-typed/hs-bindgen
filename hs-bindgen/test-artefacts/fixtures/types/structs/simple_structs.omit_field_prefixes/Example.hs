...
deriving via Struct.IsStructViaReadRaw S2_t instance Struct.IsStruct S2_t
...
deriving via Struct.IsStructViaReadRaw S3_t instance Struct.IsStruct S3_t
...
deriving via Struct.IsStructViaReadRaw S4 instance Struct.IsStruct S4
...
deriving via Struct.IsStructViaReadRaw S7a_Aux instance Struct.IsStruct S7a_Aux
...
deriving via Struct.IsStructViaReadRaw S7b_Aux instance Struct.IsStruct S7b_Aux
