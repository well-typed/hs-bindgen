...
module Example.Unsafe
    ( Example.Unsafe.thing_fun_1
    , Example.Unsafe.thing_fun_2
    , Example.Unsafe.thing_fun_3a
    , Example.Unsafe.thing_fun_3b
    )
  where
...
thing_fun_1 =
  \x0 ->
    BG.with x0 (\x1 -> hs_bindgen_0bdddf60550fc97b x1)
