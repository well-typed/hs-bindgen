...
deriving via Struct.IsStructViaReadRaw SSS_anon'anon'x_anon'x instance Struct.IsStruct SSS_anon'anon'x_anon'x
...
deriving via Struct.IsStructViaReadRaw SSS_anon'anon'x instance Struct.IsStruct SSS_anon'anon'x
...
deriving via Struct.IsStructViaReadRaw SSS instance Struct.IsStruct SSS
...
deriving via Struct.IsStructViaReadRaw USS_anon'anon'x_anon'x instance Struct.IsStruct USS_anon'anon'x_anon'x
...
deriving via Struct.IsStructViaReadRaw USS_anon'anon'x instance Struct.IsStruct USS_anon'anon'x
...
instance ( ty ~ USS_anon'anon'x
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"anon'anon'x" x0)
...
deriving via Struct.IsStructViaReadRaw SUS_anon'anon'x_anon'x instance Struct.IsStruct SUS_anon'anon'x_anon'x
...
instance ( ty ~ SUS_anon'anon'x_anon'x
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"anon'x" x0)
...
deriving via Struct.IsStructViaReadRaw SUS instance Struct.IsStruct SUS
...
deriving via Struct.IsStructViaReadRaw UUS_anon'anon'x_anon'x instance Struct.IsStruct UUS_anon'anon'x_anon'x
...
instance ( ty ~ BG.CInt
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"x" x0)
...
deriving via Struct.IsStructViaReadRaw SSU_anon'anon'x instance Struct.IsStruct SSU_anon'anon'x
...
deriving via Struct.IsStructViaReadRaw SSU instance Struct.IsStruct SSU
...
deriving via Struct.IsStructViaReadRaw USU_anon'anon'x instance Struct.IsStruct USU_anon'anon'x
...
deriving via Struct.IsStructViaReadRaw SUU instance Struct.IsStruct SUU
