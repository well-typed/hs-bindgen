...
deriving via Struct.IsStructViaReadRaw SS_anon'y instance Struct.IsStruct SS_anon'y
...
deriving via Struct.IsStructViaReadRaw SS instance Struct.IsStruct SS
...
deriving via Struct.IsStructViaReadRaw SU instance Struct.IsStruct SU
...
deriving via Struct.IsStructViaReadRaw US_anon'y instance Struct.IsStruct US_anon'y
