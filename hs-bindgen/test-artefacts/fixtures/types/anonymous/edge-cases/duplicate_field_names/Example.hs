...
deriving via Struct.IsStructViaReadRaw S_y_anon'x instance Struct.IsStruct S_y_anon'x
...
deriving via Struct.IsStructViaReadRaw S_y instance Struct.IsStruct S_y
