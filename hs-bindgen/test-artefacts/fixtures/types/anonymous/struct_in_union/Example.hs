...
deriving via RIP.SizedByteArray 8 4 instance Union.IsUnion Outer1
...
deriving via RIP.SizedByteArray 8 4 instance Union.IsUnion Outer2
...
deriving via RIP.SizedByteArray 8 4 instance Union.IsUnion Outer3
