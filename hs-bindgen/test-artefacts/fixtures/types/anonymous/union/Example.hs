...
instance ( ty ~ BG.CInt
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"has_implicit_fields_x1" x0)
...
instance ( ty ~ BG.CInt
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"has_implicit_fields_x3" x0)
...
instance ( ty ~ BG.CInt
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"has_implicit_fields_x5" x0)
