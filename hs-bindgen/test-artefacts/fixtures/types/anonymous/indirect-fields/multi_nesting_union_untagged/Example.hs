...
newtype S_anon'anon'x_anon'x_x = S_anon'anon'x_anon'x_x
  { unwrapS_anon'anon'x_anon'x_x :: BG.ByteArray
  }
  deriving stock (BG.Generic)

deriving via BG.SizedByteArray 4 4 instance Marshal.StaticSize S_anon'anon'x_anon'x_x

deriving via BG.SizedByteArray 4 4 instance Marshal.ReadRaw S_anon'anon'x_anon'x_x

deriving via BG.SizedByteArray 4 4 instance Marshal.WriteRaw S_anon'anon'x_anon'x_x

deriving via Marshal.EquivStorable S_anon'anon'x_anon'x_x instance BG.Storable S_anon'anon'x_anon'x_x

deriving via BG.SizedByteArray 4 4 instance Union.IsUnion S_anon'anon'x_anon'x_x
...
-}
instance ( ty ~ BG.CInt
         ) => BG.HasField "s_anon'anon'x_anon'x_x_a" S_anon'anon'x_anon'x_x ty where
...
instance ( ty ~ BG.CInt
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"s_anon'anon'x_anon'x_x_a" x0)
