...
instance Marshal.ReadRaw S_anon'x_x where
  ...
  readRaw =
    \ptr0 ->
          pure S_anon'x_x
      <*> HasCField.readRaw (BG.Proxy @"s_anon'x_x_a") ptr0
...
instance Marshal.WriteRaw S_anon'x_x where
  ...
  writeRaw =
    \ptr0 ->
      \s1 ->
        case s1 of
          S_anon'x_x s_anon'x_x_a2 ->
            HasCField.writeRaw (BG.Proxy @"s_anon'x_x_a") ptr0 s_anon'x_x_a2

deriving via Marshal.EquivStorable S_anon'x_x instance BG.Storable S_anon'x_x

deriving via Struct.IsStructViaReadRaw S_anon'x_x instance Struct.IsStruct S_anon'x_x
...
instance ( ty ~ BG.CInt
  ...
  hasField =
    \x0 ->
      (\y1 ->
         S_anon'x_x {s_anon'x_x_a = y1}, BG.getField @"s_anon'x_x_a" x0)
