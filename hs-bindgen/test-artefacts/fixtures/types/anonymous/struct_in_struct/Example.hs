...
deriving via Struct.IsStructViaReadRaw Outer1_anon'fieldX instance Struct.IsStruct Outer1_anon'fieldX
...
deriving via Struct.IsStructViaReadRaw Outer1 instance Struct.IsStruct Outer1
...
deriving via Struct.IsStructViaReadRaw Outer2_fieldB instance Struct.IsStruct Outer2_fieldB
...
deriving via Struct.IsStructViaReadRaw Outer2 instance Struct.IsStruct Outer2
...
deriving via Struct.IsStructViaReadRaw Inner3 instance Struct.IsStruct Inner3
...
deriving via Struct.IsStructViaReadRaw Outer3 instance Struct.IsStruct Outer3
