...
deriving via Struct.IsStructViaReadRaw Omitted instance Struct.IsStruct Omitted
...
deriving via Struct.IsStructViaReadRaw DirectlyDependsOnOmitted instance Struct.IsStruct DirectlyDependsOnOmitted
...
deriving via Struct.IsStructViaReadRaw IndirectlyDependsOnOmitted instance Struct.IsStruct IndirectlyDependsOnOmitted
