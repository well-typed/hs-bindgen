...
deriving via Struct.IsStructViaReadRaw Blk_struct instance Struct.IsStruct Blk_struct
...
deriving via Struct.IsStructViaReadRaw Blkarg_struct instance Struct.IsStruct Blkarg_struct
