...
deriving via Struct.IsStructViaReadRaw OkBefore instance Struct.IsStruct OkBefore
...
deriving via Struct.IsStructViaReadRaw OkAfter instance Struct.IsStruct OkAfter
