...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_typedef.h@
-}
instance (ty ~ MyInt) => BG.HasField "t1_x" T1 ty where
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_typedef.h@
-}
instance (ty ~ MyInt) => BG.HasField "t2_Aux_x" T2_Aux ty where
...
instance (ty ~ MyInt) => BG.CompatHasField.HasField "t2_Aux_x" T2_Aux ty where
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"t2_Aux_x" x0)
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_typedef.h@
-}
instance (ty ~ MyInt) => BG.HasField "t3_Aux_x" T3_Aux ty where
...
instance (ty ~ MyInt) => BG.CompatHasField.HasField "t3_Aux_x" T3_Aux ty where
  ...
  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"t3_Aux_x" x0)
