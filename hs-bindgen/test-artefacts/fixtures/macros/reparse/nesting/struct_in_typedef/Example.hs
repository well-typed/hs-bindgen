...
deriving via Struct.IsStructViaStorable T2_Aux instance Struct.IsStruct T2_Aux
...
deriving via Struct.IsStructViaStorable T3_Aux instance Struct.IsStruct T3_Aux
