...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_variable.h@
-}
instance (ty ~ BG.CInt) => BG.HasField "g1_x" G1 ty where
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_variable.h@
-}
instance (ty ~ BG.CInt) => BG.CompatHasField.HasField "g1_x" G1 ty where

  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"g1_x" x0)

instance (ty ~ BG.CInt) => BG.HasField "g1_x" (BG.Ptr G1) (BG.Ptr ty) where

  getField = HasCField.fromPtr (BG.Proxy @"g1_x")

instance HasCField.HasCField G1 "g1_x" where

  type CFieldType G1 "g1_x" = BG.CInt
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_variable.h@
-}
instance (ty ~ BG.CInt) => BG.HasField "g2_x" G2 ty where
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_variable.h@
-}
instance (ty ~ BG.CInt) => BG.CompatHasField.HasField "g2_x" G2 ty where

  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"g2_x" x0)

instance (ty ~ BG.CInt) => BG.HasField "g2_x" (BG.Ptr G2) (BG.Ptr ty) where

  getField = HasCField.fromPtr (BG.Proxy @"g2_x")

instance HasCField.HasCField G2 "g2_x" where

  type CFieldType G2 "g2_x" = BG.CInt
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_variable.h@
-}
instance (ty ~ BG.CInt) => BG.HasField "g3_x" G3 ty where
...
{-| __C declaration:__ @x@
    ...
    __exported by:__ @macros\/reparse\/nesting\/union_in_variable.h@
-}
instance (ty ~ BG.CInt) => BG.CompatHasField.HasField "g3_x" G3 ty where

  hasField =
    \x0 ->
      (\y1 ->
         BG.setUnionPayload y1 x0, BG.getField @"g3_x" x0)

instance (ty ~ BG.CInt) => BG.HasField "g3_x" (BG.Ptr G3) (BG.Ptr ty) where

  getField = HasCField.fromPtr (BG.Proxy @"g3_x")

instance HasCField.HasCField G3 "g3_x" where

  type CFieldType G3 "g3_x" = BG.CInt
