...
deriving via Struct.IsStructViaReadRaw T2_Aux instance Struct.IsStruct T2_Aux
...
deriving via Struct.IsStructViaReadRaw T3_Aux instance Struct.IsStruct T3_Aux
