...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_quux1@
hs_bindgen_8c77c87c8985f5b4 :: IO (BG.FunPtr (MC -> TC -> IO BG.CChar))
...
-}
quux1 :: BG.FunPtr (MC -> TC -> IO BG.CChar)
quux1 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_quux2@
hs_bindgen_ad1c057fd2e38491 :: IO (BG.FunPtr (MC -> BG.CChar -> IO TC))
...
{-| __C declaration:__ @quux2@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
quux2 :: BG.FunPtr (MC -> BG.CChar -> IO TC)
quux2 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_wam1@
hs_bindgen_05b0ef45be2bc377 :: IO (BG.FunPtr (BG.CFloat -> BG.Ptr TC -> IO (BG.Ptr MC)))
...
{-| __C declaration:__ @wam1@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
wam1 :: BG.FunPtr (BG.CFloat -> BG.Ptr TC -> IO (BG.Ptr MC))
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_wam2@
hs_bindgen_cd643a7a3c18ccf6 :: IO (BG.FunPtr (BG.CFloat -> BG.Ptr MC -> IO (BG.Ptr TC)))
...
{-| __C declaration:__ @wam2@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
wam2 :: BG.FunPtr (BG.CFloat -> BG.Ptr MC -> IO (BG.Ptr TC))
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_struct_typedef1@
hs_bindgen_0322539d81aee229 :: IO (BG.FunPtr (BG.Ptr Struct2 -> MC -> IO ()))
...
{-| __C declaration:__ @struct_typedef1@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
struct_typedef1 :: BG.FunPtr (BG.Ptr Struct2 -> MC -> IO ())
struct_typedef1 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_struct_typedef2@
hs_bindgen_8522498cba39ada6 :: IO (BG.FunPtr (BG.Ptr Struct3_t -> MC -> IO ()))
...
{-| __C declaration:__ @struct_typedef2@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
struct_typedef2 :: BG.FunPtr (BG.Ptr Struct3_t -> MC -> IO ())
struct_typedef2 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_struct_typedef3@
hs_bindgen_e19fc7f7dee46424 :: IO (BG.FunPtr (BG.Ptr Struct4 -> MC -> IO ()))
...
{-| __C declaration:__ @struct_typedef3@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
struct_typedef3 :: BG.FunPtr (BG.Ptr Struct4 -> MC -> IO ())
struct_typedef3 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_struct_name1@
hs_bindgen_00f81edda453ec64 :: IO (BG.FunPtr (BG.Ptr Struct1 -> MC -> IO ()))
...
{-| __C declaration:__ @struct_name1@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
struct_name1 :: BG.FunPtr (BG.Ptr Struct1 -> MC -> IO ())
struct_name1 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_struct_name2@
hs_bindgen_8f4de3d502f3466d :: IO (BG.FunPtr (BG.Ptr Struct3 -> MC -> IO ()))
...
{-| __C declaration:__ @struct_name2@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
struct_name2 :: BG.FunPtr (BG.Ptr Struct3 -> MC -> IO ())
struct_name2 =
...
-- __unique:__ @test_macrosmacro_in_fundecl_vs_typ_Example_get_struct_name3@
hs_bindgen_ba133ae0ff062248 :: IO (BG.FunPtr (BG.Ptr Struct4 -> MC -> IO ()))
...
{-| __C declaration:__ @struct_name3@
    ...
    __exported by:__ @macros\/macro_in_fundecl_vs_typedef.h@
-}
struct_name3 :: BG.FunPtr (BG.Ptr Struct4 -> MC -> IO ())
struct_name3 =
