...
deriving via Struct.IsStructViaReadRaw Baz instance Struct.IsStruct Baz
...
deriving via Struct.IsStructViaReadRaw Qux instance Struct.IsStruct Qux
...
deriving via Struct.IsStructViaReadRaw FILE instance Struct.IsStruct FILE
