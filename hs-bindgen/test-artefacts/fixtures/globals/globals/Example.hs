...
deriving via Struct.IsStructViaReadRaw Config instance Struct.IsStruct Config
...
deriving via Struct.IsStructViaReadRaw Inline_struct instance Struct.IsStruct Inline_struct
...
deriving via Struct.IsStructViaReadRaw Version_t instance Struct.IsStruct Version_t
