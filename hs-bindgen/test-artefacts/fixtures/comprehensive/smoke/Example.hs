...
deriving via Struct.IsStructViaReadRaw Bar1_t instance Struct.IsStruct Bar1_t
...
deriving via Struct.IsStructViaReadRaw Bar2_t instance Struct.IsStruct Bar2_t
...
deriving via Struct.IsStructViaReadRaw Bar3_t instance Struct.IsStruct Bar3_t
