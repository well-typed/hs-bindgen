...
$(HsBindgen.Runtime.Prelude.addCSource (HsBindgen.Runtime.Prelude.unlines
  ...
  , "Header hs_bindgen_42d4f5030cab5367 (void)"
  , "{"
  , "  return headerNew();"
  , "}"
  , "Header hs_bindgen_a532fed23d61816a ("
  , "  Header arg1"
  , ")"
  , "{"
  , "  return headerFree(arg1);"
  , "}"
  , "Header hs_bindgen_75661c72d673e7b5 ("
  , "  Header arg1"
  , ")"
  , "{"
  , "  return headerLink(arg1);"
  , "}"
  , "unsigned int hs_bindgen_d638b9e384986672 ("
  , "  Header arg1,"
  , "  signed int arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "void *hs_bindgen_e964a92bfdd975c4 ("
  , "  Header arg1,"
  , "  unsigned int *arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "Header hs_bindgen_221e16fb714908cd ("
  , "  Header arg1,"
  , "  rpmTagVal arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "Header hs_bindgen_9be5145cf31532e1 ("
  , "  Header arg1"
  , ")"
  , "{"
  , "  return headerCopy(arg1);"
  , "}"
  , "Header hs_bindgen_a6902fcc94a9e7a2 ("
  , "  void *arg1,"
  , "  unsigned int arg2,"
  ...
  , "}"
  , "Header hs_bindgen_e49850377a368cc1 ("
  , "  FD_t arg1,"
  , "  signed int arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_f8bba9a7cb33f6c9 ("
  , "  FD_t arg1,"
  , "  Header arg2,"
  , "  signed int arg3"
  , ")"
  ...
  , "}"
  , "signed int hs_bindgen_90360b2e1fe04232 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_53a4570fd6a1b39b ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  rpmtd arg3,"
  , "  headerGetFlags arg4"
  ...
  , "}"
  , "signed int hs_bindgen_b03396d4b1766616 ("
  , "  Header arg1,"
  , "  rpmtd arg2,"
  , "  headerPutFlags arg3"
  , ")"
  ...
  , "}"
  , "signed int hs_bindgen_c29d817141a94cb0 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  uint8_t const *arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_446e6d2af9ab3f4f ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  char const *arg3"
  , ")"
  ...
  , "}"
  , "signed int hs_bindgen_d9863b56de65be10 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  char const **arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_7a9fa0af8683ccd8 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  char const *arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_5fc985d7b7717734 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  uint8_t const *arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_12c87a18a679df83 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  uint16_t const *arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_0d3e37b355576bb6 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  uint32_t const *arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_2467e64cc9e5e8ed ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  uint64_t const *arg3,"
  , "  rpm_count_t arg4"
  ...
  , "}"
  , "signed int hs_bindgen_8aa9574493dfe187 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2,"
  , "  char const *arg3,"
  , "  char const *arg4"
  ...
  , "}"
  , "signed int hs_bindgen_7a1050885f22ea30 ("
  , "  Header arg1,"
  , "  rpmtd arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_d280b458476e6e10 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "char *hs_bindgen_e294b0ff38d0c4d8 ("
  , "  Header arg1,"
  , "  char const *arg2,"
  , "  errmsg_t *arg3"
  , ")"
  ...
  , "}"
  , "void hs_bindgen_bdd06a68c1066fb5 ("
  , "  Header arg1,"
  , "  Header arg2,"
  ...
  , "}"
  , "HeaderIterator hs_bindgen_c4659961fd925993 ("
  , "  HeaderIterator arg1"
  , ")"
  , "{"
  , "  return headerFreeIterator(arg1);"
  , "}"
  , "HeaderIterator hs_bindgen_91786fd720b0dc1e ("
  , "  Header arg1"
  , ")"
  , "{"
  , "  return headerInitIterator(arg1);"
  , "}"
  , "signed int hs_bindgen_e7a4620d86e878f3 ("
  , "  HeaderIterator arg1,"
  , "  rpmtd arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "rpmTagVal hs_bindgen_8dc8630422ad28e1 ("
  , "  HeaderIterator arg1"
  , ")"
  , "{"
  , "  return headerNextTag(arg1);"
  , "}"
  , "char *hs_bindgen_0e351e37ccdada67 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "char const *hs_bindgen_7a6f0de8817a6a38 ("
  , "  Header arg1,"
  , "  rpmTagVal arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "uint64_t hs_bindgen_b1da04708297369c ("
  , "  Header arg1,"
  , "  rpmTagVal arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_618dd643eacb6ea4 ("
  , "  Header arg1"
  , ")"
  , "{"
  , "  return headerIsSource(arg1);"
  , "}"
  , "unsigned int hs_bindgen_4cc4873bb13f217a ("
  , "  Header arg1"
  , ")"
  , "{"
  , "  return headerGetInstance(arg1);"
  , "}"
  , "signed int hs_bindgen_02ae5cf73790e8d2 ("
  , "  Header arg1,"
  , "  signed int arg2"
  , ")"
  , "{"
...
-}
foreign import ccall safe "hs_bindgen_42d4f5030cab5367" headerNew ::
     IO RPM.Types.Header
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_a532fed23d61816a" headerFree ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_75661c72d673e7b5" headerLink ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_d638b9e384986672" headerSizeof ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_e964a92bfdd975c4" headerExport ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_221e16fb714908cd" headerReload ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_9be5145cf31532e1" headerCopy ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_a6902fcc94a9e7a2" headerImport ::
     Ptr.Ptr Void
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_e49850377a368cc1" headerRead ::
     RPM.Types.FD_t
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_f8bba9a7cb33f6c9" headerWrite ::
     RPM.Types.FD_t
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_90360b2e1fe04232" headerIsEntry ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_53a4570fd6a1b39b" headerGet ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_b03396d4b1766616" headerPut ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_c29d817141a94cb0" headerPutBin ::
     RPM.Types.Header
     {- ^
...
{-| __C declaration:__ @headerPutString@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_446e6d2af9ab3f4f" headerPutString ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
{-| __C declaration:__ @headerPutStringArray@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_d9863b56de65be10" headerPutStringArray ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
{-| __C declaration:__ @headerPutChar@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_7a9fa0af8683ccd8" headerPutChar ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
{-| __C declaration:__ @headerPutUint8@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_5fc985d7b7717734" headerPutUint8 ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
{-| __C declaration:__ @headerPutUint16@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_12c87a18a679df83" headerPutUint16 ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
{-| __C declaration:__ @headerPutUint32@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_0d3e37b355576bb6" headerPutUint32 ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
{-| __C declaration:__ @headerPutUint64@
    ...
    __exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_2467e64cc9e5e8ed" headerPutUint64 ::
     RPM.Types.Header
     {- ^ __C declaration:__ @h@
     -}
  -> RPM.Td.RpmTagVal
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_8aa9574493dfe187" headerAddI18NString ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_7a1050885f22ea30" headerMod ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_d280b458476e6e10" headerDel ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_e294b0ff38d0c4d8" headerFormat ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_bdd06a68c1066fb5" headerCopyTags ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_c4659961fd925993" headerFreeIterator ::
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_91786fd720b0dc1e" headerInitIterator ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_e7a4620d86e878f3" headerNext ::
     RPM.Types.HeaderIterator
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_8dc8630422ad28e1" headerNextTag ::
     RPM.Types.HeaderIterator
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_0e351e37ccdada67" headerGetAsString ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_7a6f0de8817a6a38" headerGetString ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_b1da04708297369c" headerGetNumber ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_618dd643eacb6ea4" headerIsSource ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_4cc4873bb13f217a" headerGetInstance ::
     RPM.Types.Header
     {- ^
...
__exported by:__ @rpm\/header.h@
-}
foreign import ccall safe "hs_bindgen_02ae5cf73790e8d2" headerConvert ::
     RPM.Types.Header
     {- ^
