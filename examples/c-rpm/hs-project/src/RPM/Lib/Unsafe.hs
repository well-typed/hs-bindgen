...
$(HsBindgen.Runtime.Prelude.addCSource (HsBindgen.Runtime.Prelude.unlines
  ...
  , "signed int hs_bindgen_67728c1adb65ade4 ("
  , "  char const *arg1,"
  , "  char const *arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "void hs_bindgen_ac626dcee24f7844 ("
  , "  char const **arg1,"
  , "  signed int *arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_d07fcd3f71473e06 ("
  , "  char const *arg1"
  , ")"
  , "{"
  , "  return rpmGetArchColor(arg1);"
  , "}"
  , "void hs_bindgen_3fa82b6f3073319f ("
  , "  char const **arg1,"
  , "  signed int *arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_0f32a9598a3e0044 ("
  , "  signed int arg1,"
  , "  char const *arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "signed int hs_bindgen_b9f4505c07dd98ec ("
  , "  FILE *arg1"
  , ")"
  , "{"
  , "  return rpmShowRC(arg1);"
  , "}"
  , "void hs_bindgen_1df2f12e7e59baa0 (void)"
  , "{"
  , "  rpmFreeRpmrc();"
  , "}"
  , "signed int hs_bindgen_5113203ceba7c4e3 ("
  , "  Header arg1,"
  , "  Header arg2"
  , ")"
  , "{"
  ...
  , "}"
  , "rpmRC hs_bindgen_bfceca3b20f1b989 ("
  , "  rpmts arg1,"
  , "  void const *arg2,"
  , "  size_t arg3,"
  , "  char **arg4"
  ...
  , "}"
  , "rpmRC hs_bindgen_8edccc2185cc0d18 ("
  , "  rpmts arg1,"
  , "  FD_t arg2,"
  , "  Header *arg3,"
  , "  char **arg4"
  ...
  , "}"
  , "rpmRC hs_bindgen_a8851bdf2ae99c42 ("
  , "  rpmts arg1,"
  , "  FD_t arg2,"
  , "  char const *arg3,"
  , "  Header *arg4"
  ...
  , "}"
  , "rpmRC hs_bindgen_722193134d03ec5a ("
  , "  rpmts arg1,"
  , "  FD_t arg2,"
  , "  char **arg3,"
  , "  char **arg4"
...
-}
foreign import ccall unsafe "hs_bindgen_67728c1adb65ade4" rpmReadConfigFiles ::
     Ptr.Ptr FC.CChar
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_ac626dcee24f7844" rpmGetArchInfo ::
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_d07fcd3f71473e06" rpmGetArchColor ::
     Ptr.Ptr FC.CChar
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_3fa82b6f3073319f" rpmGetOsInfo ::
     Ptr.Ptr (Ptr.Ptr FC.CChar)
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_0f32a9598a3e0044" rpmMachineScore ::
     FC.CInt
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_b9f4505c07dd98ec" rpmShowRC ::
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_1df2f12e7e59baa0" rpmFreeRpmrc ::
     IO ()
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_5113203ceba7c4e3" rpmVersionCompare ::
     Header
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_bfceca3b20f1b989" headerCheck ::
     Rpmts
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_8edccc2185cc0d18" rpmReadHeader ::
     Rpmts
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_a8851bdf2ae99c42" rpmReadPackageFile ::
     Rpmts
     {- ^
...
__exported by:__ @rpm\/rpmlib.h@
-}
foreign import ccall unsafe "hs_bindgen_722193134d03ec5a" rpmInstallSourcePackage ::
     Rpmts
     {- ^
