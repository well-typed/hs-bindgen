...
-- properties. Dictionaries carry static information that is checked ("tested")
-- by the compiler. However, since Haskell is a lazy language, we should still
-- check dynamically that the dictionaries are not
