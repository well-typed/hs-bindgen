...
dict_hasField_MyStruct_x :: Dict $
     HasField "myStruct_x" (Ptr Types.MyStruct) (Ptr CInt)
dict_hasField_MyStruct_x = Dict

dict_hasField_MyStruct_y :: Dict $
     HasField "myStruct_y" (Ptr Types.MyStruct) (Ptr CChar)
dict_hasField_MyStruct_y = Dict
...
dict_hasField_MyUnion_x :: Dict $
     HasField "myUnion_x" (Ptr Types.MyUnion) (Ptr CInt)
dict_hasField_MyUnion_x = Dict

dict_hasField_MyUnion_y :: Dict $
     HasField "myUnion_y" (Ptr Types.MyUnion) (Ptr CChar)
dict_hasField_MyUnion_y = Dict
...
dict_hasField_MyEnum_unwrap :: Dict $
     HasField "unwrapMyEnum" (Ptr Types.MyEnum) (Ptr CUInt)
dict_hasField_MyEnum_unwrap = Dict
...
dict_hasField_MyStructBF_x :: Dict $
     HasField "myStructBF_x" (Ptr Types.MyStructBF) (BitfieldPtr CInt)
dict_hasField_MyStructBF_x = Dict

dict_hasField_MyStructBF_y :: Dict $
     HasField "myStructBF_y" (Ptr Types.MyStructBF) (BitfieldPtr CChar)
dict_hasField_MyStructBF_y = Dict

-- TODO <https://github.com/well-typed/hs-bindgen/issues/1253>
--
-- It should be @BitfieldPtr CInt@ instead of @Ptr CInt@
dict_hasField_MyUnionBF_x :: Dict $
     HasField "myUnionBF_x" (Ptr Types.MyUnionBF) (Ptr CInt)
dict_hasField_MyUnionBF_x = Dict

-- TODO <https://github.com/well-typed/hs-bindgen/issues/1253>
--
-- It should be @BitfieldPtr CChar@ instead of @Ptr CChar@
dict_hasField_MyUnionBF_y :: Dict $
     HasField "myUnionBF_y" (Ptr Types.MyUnionBF) (Ptr CChar)
dict_hasField_MyUnionBF_y = Dict
...
dict_hasField_MyTypedef_unwrap :: Dict $
     HasField "unwrapMyTypedef" (Ptr Types.MyTypedef) (Ptr CInt)
dict_hasField_MyTypedef_unwrap = Dict
...
dict_hasField_MyArrayKnownSize_unwrap :: Dict $
     HasField "unwrapMyArrayKnownSize" (Ptr Types.MyArrayKnownSize) (Ptr (ConstantArray 3 CInt))
dict_hasField_MyArrayKnownSize_unwrap = Dict
...
dict_hasField_MyArrayUnknownSize_unwrap :: Dict $
     HasField "unwrapMyArrayUnknownSize" (Ptr Types.MyArrayUnknownSize) (Ptr (IncompleteArray CInt))
dict_hasField_MyArrayUnknownSize_unwrap = Dict
...
dict_hasField_MyStructFLAM_len :: Dict $
     HasField "myStructFLAM_len" (Ptr Types.MyStructFLAM) (Ptr CInt)
...
dict_hasField_MyStructFLAM_data :: Dict $
     HasField "myStructFLAM_len" (Ptr Types.MyStructFLAM) (Ptr (IncompleteArray CChar))
...
dict_hasField_MyStructFLAM_Aux_len :: Dict $
     HasField "myStructFLAM_len" (Ptr Types.MyStructFLAM_Aux) (Ptr CInt)
dict_hasField_MyStructFLAM_Aux_len = Dict
...
dict_hasField_MyStructAnon_x :: Dict $
     HasField "myStructAnon_x" (Ptr Types.MyStructAnon) (Ptr Types.MyStructAnon_x)
dict_hasField_MyStructAnon_x = Dict

dict_hasField_MyUnionAnon_x :: Dict $
     HasField "myUnionAnon_x" (Ptr Types.MyUnionAnon) (Ptr Types.MyUnionAnon_x)
dict_hasField_MyUnionAnon_x = Dict
