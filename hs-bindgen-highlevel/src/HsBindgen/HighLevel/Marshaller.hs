...
--
-- @c@ is representation-polymorphic (it only ever appears in a function argument
-- position, never bound), so an 'Unmarshaller' can front a lifted @'Ptr' c@ output
-- or an unlifted by-value @W@ struct output. See
