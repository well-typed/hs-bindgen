...
-- 'Marshal' constructor (several), or an out-parameter constructor ('unmarshalOut' \/
...
-- length is a separate C argument (a 'HsBindgen.HighLevel.fixed' at the call site, or
