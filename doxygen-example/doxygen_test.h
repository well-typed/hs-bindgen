...
/**
 * @var static bool is_initialized
 ...
 * @brief Structure with nested anonymous structures and unions
 */
typedef struct {
    /**
     * @brief Anonymous union for different data types
     */
    union {
        int int_value;      /**< @brief Integer value */
        float float_value;  /**< @brief Float value */

        /**
         * @brief Anonymous structure for coordinate
         */
        struct {
...
/**
 * @var const int constant_array[]
 * @brief Constant array with documentation
 */
const int constant_array[] = {1, 2, 3, 4, 5};

/**
 * @var volatile int hardware_register
 * @brief Hardware register (volatile)
 */
