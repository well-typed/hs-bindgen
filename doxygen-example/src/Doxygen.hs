...
$(CAPI.addCSource "#include \"doxygen_test.h\"\nsigned int Doxygen_process_data (uint8_t *arg1, uint8_t *arg2, size_t *arg3) { return process_data(arg1, arg2, arg3); }\n_Bool Doxygen_process_file (char *arg1) { return process_file(arg1); }\nsigned int Doxygen_calculate_value (signed int arg1, signed int arg2) { return calculate_value(arg1, arg2); }\n_Bool Doxygen_html_example (signed int arg1) { return html_example(arg1); }\n_Bool Doxygen_list_example (char **arg1, size_t arg2) { return list_example(arg1, arg2); }\nvoid *Doxygen_dangerous_function (void *arg1) { return dangerous_function(arg1); }\nsigned int Doxygen_detailed_return_codes (char *arg1) { return detailed_return_codes(arg1); }\nsigned int Doxygen_old_function (signed int arg1) { return old_function(arg1); }\nsigned int Doxygen_versioned_function (signed int arg1) { return versioned_function(arg1); }\nsigned int Doxygen_process_buffer (char *arg1, size_t arg2) { return process_buffer(arg1, arg2); }\nvoid *Doxygen_my_memcpy (void *arg1, void *arg2, size_t arg3) { return my_memcpy(arg1, arg2, arg3); }\nsigned int Doxygen_double_value (signed int arg1) { return double_value(arg1); }\nstatus_code_t Doxygen_complex_function (config_t *arg1, uint8_t *arg2, size_t arg3) { return complex_function(arg1, arg2, arg3); }\n")
...
foreign import capi safe "&global_counter" global_counter :: F.Ptr FC.CInt
...
foreign import capi safe "&version_string" version_string :: F.Ptr (F.Ptr FC.CChar)
...
-}
foreign import ccall safe "Doxygen_process_data" process_data :: (F.Ptr HsBindgen.Runtime.Prelude.Word8) -> (F.Ptr HsBindgen.Runtime.Prelude.Word8) -> (F.Ptr HsBindgen.Runtime.Prelude.CSize) -> IO FC.CInt
...
-}
foreign import ccall safe "Doxygen_process_file" process_file :: (F.Ptr FC.CChar) -> IO FC.CBool
...
-}
foreign import ccall safe "Doxygen_calculate_value" calculate_value :: FC.CInt -> FC.CInt -> IO FC.CInt

{-|
  Function with HTML formatting

  This function demonstrates __ HTML bold __ and / italic / text. It also shows @ HTML code @ formatting.

  <table> <tr> <th> Input </th> <th> Output </th> </tr> <tr> <td> 0 </td> <td> false </td> </tr> <tr> <td> 1 </td> <td> true </td> </tr> </table>
...
-}
foreign import ccall safe "Doxygen_html_example" html_example :: FC.CInt -> IO FC.CBool
...
-}
foreign import ccall safe "Doxygen_list_example" list_example :: (F.Ptr (F.Ptr FC.CChar)) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CBool
...
-}
foreign import ccall safe "Doxygen_dangerous_function" dangerous_function :: (F.Ptr Void) -> IO (F.Ptr Void)
...
-}
foreign import ccall safe "Doxygen_detailed_return_codes" detailed_return_codes :: (F.Ptr FC.CChar) -> IO FC.CInt
...
-}
foreign import ccall safe "Doxygen_old_function" old_function :: FC.CInt -> IO FC.CInt
...
-}
foreign import ccall safe "Doxygen_versioned_function" versioned_function :: FC.CInt -> IO FC.CInt
...
{-|
  ...
  __from C:__ @struct (unnamed at ./doxygen_test.h:292:5)@
-}
...
{-|
  ...
  __from C:__ @hardware_register@
-}

foreign import capi safe "&hardware_register" hardware_register :: F.Ptr FC.CInt
...
-}
foreign import ccall safe "Doxygen_process_buffer" process_buffer_wrapper :: (F.Ptr FC.CChar) -> HsBindgen.Runtime.Prelude.CSize -> IO FC.CInt
...
-}
foreign import ccall safe "Doxygen_my_memcpy" my_memcpy :: (F.Ptr Void) -> (F.Ptr Void) -> HsBindgen.Runtime.Prelude.CSize -> IO (F.Ptr Void)
...
-}
foreign import ccall safe "Doxygen_double_value" double_value :: FC.CInt -> IO FC.CInt
...
-}
foreign import ccall safe "Doxygen_complex_function" complex_function :: (F.Ptr Config_t) -> (F.Ptr HsBindgen.Runtime.Prelude.Word8) -> HsBindgen.Runtime.Prelude.CSize -> IO Status_code_t
