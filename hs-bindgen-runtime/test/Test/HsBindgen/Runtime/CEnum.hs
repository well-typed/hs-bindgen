...
import HsBindgen.Runtime.CEnum (AsCEnum(AsCEnum), CEnum, CEnumException(..))
...
deriving via AsCEnum SingleValue instance Enum SingleValue
...
testSingleValue = testGroup "SingleValue" [
    ...
    , testGroup "mkDeclared" [
        ...
        , testCase "!declared" $ Nothing @=? CEnum.mkDeclared @SingleValue 2
        ]
    , testGroup "showCEnum" [
          testCase "declared" $ "OK" @=? CEnum.showCEnum "SingleValue" v1
        , testCase "!declared" $
            "SingleValue 2" @=? CEnum.showCEnum "SingleValue" v2
        ]
    , testGroup "getNames" [
    ...
    , testGroup "Enum" [
        ...
        , testGroup "toEnum" [
            ...
            , testCase "!declared" $
                CEnumNotDeclared 2 @=?! toEnum @SingleValue 2
            ]
        , testGroup "fromEnum" [
...
deriving via AsCEnum SeqPosValue instance Enum SeqPosValue
...
deriving via AsCEnum SeqNegValue instance Enum SeqNegValue
