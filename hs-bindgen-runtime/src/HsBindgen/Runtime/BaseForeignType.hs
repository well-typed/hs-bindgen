...
-- | The structure of a foreign type without newtypes
--
...
-- | The structure of a basic foreign type
--
-- In addition to true basic foreign types like 'Char', this also includes
-- non-basic foreign types coming from the "Foreign.C" modules. Most of these
-- types, like 'CInt', are newtypes around basic foreign types, but the specific
-- basic foreign type depends on the platform\/operating system, so for
-- simplicity we decided to include them here.
