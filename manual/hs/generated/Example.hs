...
foreign import capi safe "example.h mk_triple" mk_triple :: FC.CInt -> FC.CInt -> FC.CInt -> (F.Ptr Triple) -> IO ()

foreign import capi safe "example.h index_triple" index_triple :: (F.Ptr Triple) -> Index -> IO FC.CInt

foreign import capi safe "example.h sum_triple" sum_triple :: (F.Ptr Triple) -> IO Sum

foreign import capi safe "example.h average_triple" average_triple :: (F.Ptr Triple) -> IO Average

foreign import capi safe "example.h getYear" getYear :: (F.Ptr Date) -> IO FC.CInt
